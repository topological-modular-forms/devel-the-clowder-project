    ...
    \begin{enumerate}
        \item\label{inference-rules-for-identity-functions-formation-of-identity-functions}\SloganFont{Formation of Identity Functions. }We have
            \begin{webprooftree}%
                ...
                .%
            \end{webprooftree}%
        \item\label{inference-rules-for-identity-functions-identity-evaluation}\SloganFont{Identity Evaluation. }We have
            \begin{webprooftree}%
                \begin{prooftree}%
                    \hypo{\context{\Gamma}{A\type}}%
...
\begin{Proof}{Proof of \cref{inference-rules-for-identity-functions}}%
    ...
    \ProofBox{\cref{inference-rules-for-identity-functions-identity-evaluation}: Identity Evaluation}%
    We have
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{A\type}}%
...
\begin{Proof}{Proof of \cref{properties-of-composition-of-functions}}%
    ...
    \begin{scalewebprooftree}%
        ...
        \end{prooftree}%
    \end{scalewebprooftree}%
    Now, for the proof of this judgement, we have
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{f\oftype A\to B}}%
            \infer1[(ev)]{\context{\Gamma,\,x\oftype A}{f(x)\oftype B}}%
            ...
            \infer2[(W)]{\context{\Gamma,\,y\oftype B}{\id_{B}(y)\doteq y\oftype B}}
    ...
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{A\type}}%
            \infer1[(id-ev)]{\context{\Gamma,\,x\oftype B}{\id_{A}(x)\doteq x\oftype A}}%
            \hypo{\context{\Gamma}{B\type}}%
            \infer2[(W)]{\context{\Gamma,\,x\oftype A}{\id_{A}(x)\doteq x\oftype A}}
            \hypo{\context{\Gamma}{f\oftype A\to B}}%
            \infer1[(ev)]{\context{\Gamma,\,x\oftype A}{f(x)\oftype B}}%
            \infer2[(S)]{\context{\Gamma,\,x\oftype A}{f(\id_{A}(x))\doteq f(x)\oftype B}}
        \end{prooftree}%
        .%
    \end{webprooftree}%
    This finishes the proof.
