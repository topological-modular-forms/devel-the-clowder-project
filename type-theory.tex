    ...
    \begin{enumerate}
        \item\label{properties-of-identity-types-concatenation}\SloganFont{Concatenation. }There exists a dependent function\index[notation]{concat@$\concat$}%
            ...
            \[
                ...
                \left((x\equals_{A}y)\to(y\equals_{A}z\to x\equals_{A}z)\right)%
            \]%
...
\begin{Proof}{Proof of \cref{properties-of-identity-types}}%
    \FirstProofBox{\cref{properties-of-identity-types-concatenation}: Concatenation}%
    We start by first constructing a function
    \[
        \concat_{x}%
        \oftype%
        \prod_{y\oftype A}x\equals_{A}y%
        \to%
        \prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)%
    \]%
    given $x\oftype A$. For this, we first construct a dependent function
    \[
        \concat_{x}(x,\refl_{x})%
        \oftype%
    ...
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{x\oftype A}}%
            \infer1[(id-form)]{\context{\Gamma,\,z\oftype A}{x\equals_{A}z}}%
            \infer1[(id)]{\context{\Gamma}{\id_{x\equals_{A}z}\oftype x\equals_{A}z\to x\equals_{A}z}}%
            \infer1[(λ)]{\context{\Gamma}{\displaystyle\llbracket z\mapsto\id_{x\equals_{A}z}\rrbracket\oftype\prod_{z\oftype A}x\equals_{A}z\to x\equals_{A}z}}%
            \infer1{\context{\Gamma}{\displaystyle\concat_{x}(x,\refl_{x})\doteq\llbracket z\mapsto\id_{x\equals_{A}z}\rrbracket\oftype\prod_{z\oftype A}x\equals_{A}z\to x\equals_{A}z}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
    Now that we have constructed $\concat_{x}(x,\refl_{x})$, we may use path induction to obtain $\concat_{x}$:
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{x\oftype A}}%
            \hypo{\context{\Gamma,\,y\oftype A,\,p\oftype x\equals_{A}y}{\displaystyle\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)\type}}%
            \infer2[(id-ind)]{\context{\Gamma}{\displaystyle\indeq{x}\oftype\prod_{z\oftype A}(x\equals_{A}z\to x\equals_{A}z)\to\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1{\context{\Gamma}{\displaystyle\concat_{x}\doteq\indeq{x}\left(\concat_{x}(x,\refl_{x})\right)\oftype\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1{\context{\Gamma}{\displaystyle\concat_{x}\doteq\indeq{x}\left(\concat_{x}(x,\refl_{x})\right)\oftype\prod_{y\oftype A}x\equals_{A}y\to\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
    Finally, we define $\concat_{x,y,z}$ via λ-abstraction:
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma,\,x\oftype A}{\displaystyle\concat_{x}\oftype\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1[(λ)]{\context{\Gamma}{\displaystyle\llbracket x\mapsto\concat_{x}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1{\context{\Gamma}{\displaystyle\llbracket x\mapsto\concat_{x}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}\prod_{q\oftype y\equals_{A}z}x\equals_{A}z}}%
            \infer1[(swap)]{\context{\Gamma}{\displaystyle\llbracket x\mapsto\sigma\circ\concat_{x}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{z\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{q\oftype y\equals_{A}z}x\equals_{A}z}}%
            \infer1{\context{\Gamma}{\displaystyle\llbracket x\mapsto\sigma\circ\concat_{x}\rrbracket\oftype\prod_{x,y,z\oftype A}(x\equals_{A}y)\to(y\equals_{A}z\to x\equals_{A}z)}}%
        \end{prooftree}%
        .
    \end{webprooftree}%
    This finishes the construction of $\concat_{x,y,z}$.
    ...
    \[
        ...
        r\ccirc(q\ccirc\refl_{w}).%
    \]%
    For this, notice that the computation rules for identity types provide us with judgemental equalities of the form $q\ccirc\refl_{w}\doteq q$, so we have
    \begin{align*}
        (r\ccirc)q\ccirc\refl_{w} &\doteq r\ccirc q,\\
        r\ccirc(q\ccirc\refl_{w}) &\doteq r\ccirc q.
    \end{align*}
    As a result, we may define $\assoc_{w,w,y,z}(r,q,\refl_{w})=\refl_{q\circ r}$. With the construction of $\assoc_{w,w,y,z}(r,q,\refl_{w})$ at hand, we may use path induction to obtain $\assoc_{w,x,y,z}(r,q,p)$:
    \begin{scalewebprooftree}%
        \begin{prooftree}%
    ...
    \begin{webprooftree}%
        \begin{prooftree}%
            ...
            \infer2[(id-ind)]{\context{\Gamma}{\displaystyle\indeq{x}\oftype x\equals_{A}x\to\prod_{x\oftype A}(x\equals_{A}y\to y\equals_{A}x)}}%
            \infer2[(ev2)]{\context{\Gamma}{\displaystyle\indeq{x}(\refl_{x})\oftype\prod_{x\oftype A}(x\equals_{A}y\to y\equals_{A}x)}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
