...
\subsection{The Unit Type}\label{subsection-martin-löf-type-theory-the-unit-type}
...
\begin{example}{From Terms $x\oftype A$ to Functions $\pt_{x}\oftype\UnitType\to A$}{from-terms-x-oftype-a-to-functions-pt-x-oftype-unittype-to-a}%
    ...
    \end{webprooftree}%
\end{example}
\subsection{The Empty Type}\label{subsection-martin-löf-type-theory-the-empty-type}
