    ...
    \begin{itemize}
        \itemstar Given a family of types $P(x)$ indexed by $p\oftype\sum_{x\oftype A}B(x)$, there exists a function
            \begin{webcompile}
                ...
                \to%
                \left(\prod_{\displaystyle{0.7}{$\displaystyle z\oftype\sum_{x\oftype A}B(x)$}}P(z)\right)%
            \end{webcompile}
        ...
        \item\label{explicit-inference-rules-for-dependent-pair-types-induction}\SloganFont{Induction. }We have
            \begin{webprooftree}%
                \begin{prooftree}%
                    ...
                    \infer3[(Σ-ind)]{\context{\Gamma}{\displaystyle\ind_{\Sigma}\oftype\left(\prod_{x\oftype A}\prod_{y\oftype B(x)}P(\pair(x,y))\right)\to\left(\prod_{\scalebox{0.7}{$\displaystyle z\oftype\sum_{x\oftype A}B(x)$}}P(z)\right)}}%
                \end{prooftree}%
                .%
            \end{webprooftree}%
        \item\label{explicit-inference-rules-for-dependent-pair-types-computation}\SloganFont{Computation. }We have
            \begin{scalewebprooftree}%
                \begin{prooftree}%
                    ...
                    \hypo{\context{\Gamma,\,x\oftype A}{B(x)\type}}%
                    \hypo{\context{\displaystyle\Gamma,\,z\oftype\sum_{x\oftype A}B(x)}{P(z)\type}}%
                    \hypo{\context{\Gamma}{\displaystyle f\oftype\prod_{\scalebox{0.7}{$z\oftype\sum_{x\oftype A}B(x)$}}P(z)}}%
                    \infer4[(Σ-comp)]{\context{\Gamma}{\displaystyle\ind_{\Sigma}(f,\pair(x,y))\doteq f(x,y)\oftype\prod_{\scalebox{0.7}{$\displaystyle z\oftype\sum_{x\oftype A}B(x)$}}P(z)}}%
                \end{prooftree}%
                .%
            \end{scalewebprooftree}%
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item\label{projection-functions-for-sigma-types-the-second-projection-map}The \index[type-theory]{Σ-type!second projection map}\textbf{second projection map} is the dependent function
            \begin{webcompile}
                \pr_{2}%
                \oftype%
                \prod_{\scalebox{0.7}{$\displaystyle z\oftype\sum_{x\oftype A}B(x)$}}B(\pr_{1}(z))%
            \end{webcompile}
            defined via induction by
            \[
                \pr_{2}(x,y)%
    ...
    \begin{enumerate}
        \item\label{properties-of-sigma-types-currying}\SloganFont{Currying. }There exists a function\index[type-theory]{currying}%
            ...
            \begin{webcompile}
                \evpair%
                \oftype%
                \left(\prod_{\scalebox{0.7}{$\displaystyle z\oftype\sum_{x\oftype A}B(x)$}}P(z)\right)
                \to
...
\begin{remark}{Unwinding \cref{product-types}}{unwinding-product-types}%
    ...
    satisfying the following induction principle:
    \begin{itemize}
        \itemstar Given a family of types $P(z)$ indexed by $z\oftype A\times B$, there exists a function
            \[
                \ind_{\mathord{\times}}%
                \oftype%
