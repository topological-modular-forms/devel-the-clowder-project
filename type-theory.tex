...
\begin{proposition}{Properties of Identity Types}{properties-of-identity-types}%
    Let $A$ be a type and let $a\oftype A$.
    \begin{enumerate}
        \item\label{properties-of-identity-types-concatenation}\SloganFont{Concatenation. }There exists a function\index[notation]{concatxyz@$\concat_{x,y,z}$}%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Notation: }We write \index[notation]{qp@$q\cdot p$}$q\cdot p$ for $\concat_{x,y,z}(q,p)$.
                \par\vspace*{\TCBBoxCorrection}
            }%
            %---  End Footnote  ---%
            \[
            ...
            \]%
        \item\label{properties-of-identity-types-inversion}\SloganFont{Inversion. }There exists a function
            \[
                \inv_{x,y}%
                \oftype%
...
\begin{Proof}{Proof of \cref{properties-of-identity-types}}%
    ...
    \begin{webprooftree}%
        \begin{prooftree}%
            ...
            \infer1{\context{\Gamma}{\displaystyle\concat^{x}_{y,z}(x,\refl_{x})\doteq\llbracket z\mapsto\id_{x\equals_{A}z}\rrbracket\oftype\prod_{z\oftype A}x\equals_{A}z\to x\equals_{A}z}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
    Now that we have constructed $\concat^{x}_{y,z}(x,\refl_{x})$, we may use path induction to obtain $\concat^{x}_{y,z}$:
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{x\oftype A}}%
            ...
            \infer1{\context{\Gamma}{\displaystyle\concat^{x}_{y,z}\doteq\indeq{x}(\concat^{x}_{y,z}(x,\refl_{x}))\oftype\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1{\context{\Gamma}{\displaystyle\concat^{x}_{y,z}\doteq\indeq{x}(\concat^{x}_{y,z}(x,\refl_{x}))\oftype\prod_{y\oftype A}x\equals_{A}y\to\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
    ...
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma,\,x\oftype A}{\displaystyle\concat^{x}_{y,z}\oftype\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1[(λ)]{\context{\Gamma}{\displaystyle\llbracket x\mapsto\concat^{x}_{y,z}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}(y\equals_{A}z\to x\equals_{A}z)}}%
            \infer1{\context{\Gamma,\,x\oftype A}{\displaystyle\llbracket x\mapsto\concat^{x}_{y,z}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{z\oftype A}\prod_{q\oftype y\equals_{A}z}x\equals_{A}z}}%
            \infer1[(swap)]{\context{\Gamma,\,x\oftype A}{\displaystyle\llbracket x\mapsto\concat^{x}_{y,z}\rrbracket\oftype\prod_{x\oftype A}\prod_{y\oftype A}\prod_{z\oftype A}\prod_{p\oftype x\equals_{A}y}\prod_{q\oftype y\equals_{A}z}x\equals_{A}z}}%
            \infer1{\context{\Gamma,\,x\oftype A}{\displaystyle\llbracket x\mapsto\concat^{x}_{y,z}\rrbracket\oftype\prod_{x,y,z\oftype A}(x\equals_{A}y)\to(y\equals_{A}z\to x\equals_{A}z)}}%
        \end{prooftree}%
        .
    \end{webprooftree}%
