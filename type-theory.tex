...
\begin{Proof}{Proof of \cref{properties-of-composition-of-functions}}%
    ...
    This finishes the proof.
\end{Proof}
\subsection{The Natural Numbers}\label{subsection-martin-löf-type-theory-the-natural-numbers}
...
\begin{definition}{The Introduction Rules of $\N$}{the-introduction-rules-of-n}%
    Martin-Löf type theory has the following \textbf{introduction rules} rule about the type of the natural numbers:%
    \begin{enumerate}
        \item\label{the-introduction-rules-of-n-the-zero-element}\SloganFont{The Zero Element. }We have\index[notation]{ZeroN@$\Zero_{\N}$}%
            \begin{webprooftree}%
                \begin{prooftree}%
                    \hypo{}%
                    \infer1[($\N$-zero)]{\vdash\Zero_{\N}\oftype\N}%
                \end{prooftree}%
                .%
            \end{webprooftree}%
...
\begin{definition}{The Induction Principle of $\N$}{the-induction-principle-of-n}%
    Martin-Löf type theory has the following interderivable \index[type-theory]{induction principle of N@induction principle of $\N$}\textbf{induction principle} rules about the type of the natural numbers:\index[notation]{indN@$\ind_{\N}$}%
    %--- Begin Footnote ---%
    \footnote{%
        \SloganFont{Further Terminology: }The term $p_{0}\oftype P(\Zero_{\N})$ is called the \index[type-theory]{induction principle of N@induction principle of $\N$!base case}\textbf{base case}.
        \par\vspace*{\TCBBoxCorrection}
    }%
    %---  End Footnote  ---%
    %--- Begin Footnote ---%
    ...
    \begin{enumerate}
        ...
        \item\label{the-induction-principle-of-n-2}\SloganFont{The Induction Principle of $\N$, \rmII. }We have
            \begin{webprooftree}%
                \begin{prooftree}%
                    \hypo{\context{\Gamma,\,n\oftype\N}{P(n)\type}}%
                    \infer1[($\N$-ind2)]{\context{\Gamma}{\displaystyle\ind_{\N}\oftype P(\Zero_{\N})\to\left[\left[\prod_{n\oftype\N}P(n),P(\succ_{\N}(n))\right],\prod_{n\oftype\N}P(n)\right]}}%
                \end{prooftree}%
                .%
            \end{webprooftree}%
    \end{enumerate}
...
\begin{Proof}{Proof of the interderivability of \cref{the-induction-principle-of-n-1,the-induction-principle-of-n-2}}%
    ...
    First, let's derive $\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N})}{p_{0}\oftype P(\Zero_{\N})}$ from $\context{\Gamma,\,n\oftype\N}{P(n)\type}$:
    \begin{webprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma,\,n\oftype\N}{P(n)\type}}%
            \hypo{}%
            \infer1[($\N$-zero)]{\vdash\Zero_{\N}\oftype\N}%
            \infer2[(S)]{\context{\Gamma}{P(\Zero_{\N})\type}}%
            \infer1[(G)]{\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N})}{p_{0}\oftype P(\Zero_{\N})}}%
        \end{prooftree}%
        .%
    \end{webprooftree}%
    Next, we derive
    ...
    \begin{scalewebprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma,\,n\oftype\N}{P(n)\type}}%
            \hypo{\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N})}{p_{0}\oftype P(\Zero_{\N})}}%
            ...
            \infer3[(WWW)]{\context{\Gamma,\,n\oftype\N,\,p_{0}\oftype P(\Zero_{\N}),\,p_{S}\oftype\displaystyle\prod_{n\oftype\N}P(n)\to P(\succ_{\N}(n))}{p_{S}\oftype\displaystyle\prod_{n\oftype\N}P(n)\to P(\succ_{\N}(n))}}
            \infer1[($\N$-ind1)]{\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N}),\,p_{S}\oftype\displaystyle\prod_{n\oftype\N}P(n)\to P(\succ_{\N}(n))}{\displaystyle\ind_{\N}(p_{0},p_{S})\oftype\prod_{n\oftype\N}P(n)\type}}%
            \infer1[(λ)]{\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N})}{\displaystyle\llbracket p_{S}\mapsto\ind_{\N}(p_{0},p_{S})\rrbracket\oftype\left(\prod_{n\oftype\N}P(n)\type\to\prod_{n\oftype\N}P(\succ_{\N}(n))\right)\to\prod_{n\oftype\N}P(n)}}%
            \infer1[(λ)]{\context{\Gamma}{\displaystyle\llbracket p_{0}\mapsto\llbracket p_{S}\mapsto\ind_{\N}(p_{0},p_{S})\rrbracket\rrbracket\oftype P(\Zero_{\N})\to\left[\left[\prod_{n\oftype\N}\left[P(n),P(\succ_{\N}(n))\right]\right],\prod_{n\oftype\N}P(n)\right]}}%
        \end{prooftree}%
        ,%
    \end{scalewebprooftree}%
    ...
    \begin{scalewebprooftree}%
        \begin{prooftree}%
            \hypo{\context{\Gamma}{p_{0}\oftype P(0_{\N})}}%
            \hypo{\context{\Gamma,\,n\oftype\N}{P(n)\type}}%
            \infer1[($\N$-ind2)]{\context{\Gamma}{\displaystyle\ind_{\N}\oftype P(\Zero_{\N})\to\left(\left(\prod_{n\oftype\N}P(n)\to P(\succ_{\N}(n))\right)\to\prod_{n\oftype\N}P(n)\right)}}%
