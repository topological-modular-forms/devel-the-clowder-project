...
\begin{definition}{Decidable Types}{decidable-types}%
    ...
    \begin{enumerate}
        \item\label{decidable-types-decidable-types}The type $A$ is \index[type-theory]{decidable type}\textbf{decidable} if there is a term of type $A+\neg A$.%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Notation: }We write \index[notation]{isdecidableA@$\isdecidable(A)$}$\isdecidable(A)$ for $A+\neg A$.
                \par\vspace*{\TCBBoxCorrection}
            }%
            %---  End Footnote  ---%
    ...
    \end{enumerate}
\end{definition}
\begin{definition}{Examples of Decidable Types}{examples-of-decidable-types}%
