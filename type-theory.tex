...
\begin{Proof}{Proof of the Interderivability of \cref{the-induction-principle-of-n-1,the-induction-principle-of-n-2}}%
    ...
    \begin{scalewebprooftree}%
        \begin{prooftree}%
            ...
            \infer1[(λ)]{\context{\Gamma,\,p_{0}\oftype P(\Zero_{\N})}{\displaystyle\llbracket p_{S}\mapsto\ind_{\N}(p_{0},p_{S})\rrbracket\oftype\left[\prod_{n\oftype\N}P(n),\prod_{n\oftype\N}P(\succ_{\N}(n))\right]\to\prod_{n\oftype\N}P(n)}}%
