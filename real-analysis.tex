...
\subsection{Foundations}\label{subsection-foundations}
\begin{definition}{The Real Numbers}{the-real-numbers}%
    The real numbers \index[notation]{R@$\R$}$\R$ is the object universally defined via the following equivalent universal properties:
    \begin{enumerate}
...
\begin{Proof}{Proof of the Statements Made in \cref{the-real-numbers}}%
    Omitted.
\end{Proof}
\subsection{Infima and Suprema}\label{subsection-infima-and-suprema}
\begin{definition}{Infima and Suprema}{infima-and-suprema}%
    ...
    %---  End Footnote  ---%
    \begin{enumerate}
        \item\label{infima-and-suprema-infima}The \index[real-analysis]{infimum}\textbf{infimum}%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Terminology: }Also called the \index[real-analysis]{greatest lower bound}\textbf{greatest lower bound} of $S$.
                \par\vspace*{\TCBBoxCorrection}
            } %
            %---  End Footnote  ---%
            of $U$ is the real number \index[notation]{infU@$\inf(U)$}$\inf(U)$ uniquely defined by the following property:
            \begin{itemize}
                \itemstar Given $r\in\R$, if $r\leq u$ for all $u\in U$, then $r\leq\inf(U)$.
            \end{itemize}
        \item\label{infima-and-suprema-suprema}The \index[real-analysis]{supremum}\textbf{supremum}%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Terminology: }Also called the \index[real-analysis]{smallest upper bound}\textbf{smallest upper bound} of $U$.
                \par\vspace*{\TCBBoxCorrection}
            } %
            %---  End Footnote  ---%
            of $U$ is the real number \index[notation]{supU@$\sup(U)$}$\sup(U)$ uniquely defined by the following property:
            \begin{itemize}
                \itemstar Given $r\in\R$, if $u\leq r$ for all $u\in U$, then $\sup(U)\leq r$.
            \end{itemize}
    \end{enumerate}
\end{definition}
\begin{proposition}{Properties of Infima and Suprema}{properties-of-infima-and-suprema}%
    Let $U,V\in\mathcal{P}(\R)$.
    \begin{enumerate}
        \item\label{properties-of-infima-and-suprema-functoriality}\SloganFont{Functoriality. }The assignments $U\mapsto\inf(U),\sup(U)$ define functors
            \[
            ...
            \end{enumerate}
        \item\label{properties-of-infima-and-suprema-interaction-with-monotone-functions}\SloganFont{Interaction With Monotone Functions. }Given a monotone function $f\colon\R\to\R$, we have inequalities
            \begin{webcompile}
                ...
                \end{tikzcd}
            \end{webcompile}
        \item\label{properties-of-infima-and-suprema-interaction-with-addition}\SloganFont{Interaction With Addition. }We have equalities
            \begin{scalemath}
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\mathcal{P}_{0}(\R)\times\mathcal{P}_{0}(\R)}
                    \arrow[r,"+"]
                    \arrow[d,"\mathord{\inf}\times\mathord{\inf}"']
                    \&
                    {\mathcal{P}_{0}(\R)}
                    \arrow[d,"\inf"]
                    \\
                ...
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\mathcal{P}_{0}(\R)\times\mathcal{P}_{0}(\R)}
                    \arrow[r,"+"]
                    \arrow[d,"\mathord{\sup}\times\mathord{\sup}"']
                    \&
                    {\mathcal{P}_{0}(\R)}
                    \arrow[d,"\sup"]
                    \\
                ...
                \end{tikzcd}
            \end{scalemath}
        \item\label{properties-of-infima-and-suprema-interaction-with-multiplication}\SloganFont{Interaction With Multiplication. }We have equalities
            \begin{scalemath}
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\mathcal{P}_{0}(\R)\times\mathcal{P}_{0}(\R)}
                    \arrow[r,"\cdot"]
                ...
                \end{tikzcd}
            \end{scalemath}
        \item\label{properties-of-infima-and-suprema-interaction-with-scalar-products}\SloganFont{Interaction With Scalar Products. }We have equalities
            \begin{scalemath}
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\R_{\geq0}\times\mathcal{P}(\R)}
                    \arrow[r,"\cdot"]
                    \arrow[d,"\id_{\R_{\geq0}}\times\mathord{\inf}"']
                    \&
                    {\mathcal{P}(\R)}
                    \arrow[d,"\inf"]
                    \\
                ...
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\R_{\geq0}\times\mathcal{P}(\R)}
                    \arrow[r,"\cdot"]
                    \arrow[d,"\id_{\R_{\leq0}}\times\mathord{\sup}"']
                    \&
                    {\mathcal{P}(\R)}
                    \arrow[d,"\sup"]
                    \\
            ...
            \begin{scalemath}
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={7.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    {\R_{\leq0}\times\mathcal{P}(\R)}
                    \arrow[r,"\cdot"]
                    \arrow[d,"\id_{\R_{\leq0}}\times\mathord{\inf}"']
                    \&
                    {\mathcal{P}(\R)}
                    \arrow[d,"\inf"]
                    \\
                ...
                \end{tikzcd}
            \end{scalemath}
        \item\label{properties-of-infima-and-suprema-interaction-with-additive-inverses}\SloganFont{Interaction With Additive Inverses. }We have equalities
            \begin{align*}
                \inf(-A) &= -\sup(A),\\
                \sup(-A) &= -\inf(A).
            \end{align*}
        \item\label{properties-of-infima-and-suprema-interaction-with-multiplicative-inverses}\SloganFont{Interaction With Multiplicative Inverses. }We have equalities
            \begin{align*}
                \inf\pig(A^{-1}\pig) &= \sup(A)^{-1},\\
                \sup\pig(A^{-1}\pig) &= \inf(A)^{-1}.
            \end{align*}
        %\item\label{properties-of-infima-and-suprema-}\SloganFont{. }
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-infima-and-suprema}}%
    \FirstProofBox{\cref{properties-of-infima-and-suprema-functoriality}: Functoriality}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-monotone-functions}: Interaction With Monotone Functions}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-addition}: Interaction With Addition}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-multiplication}: Interaction With Multiplication}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-scalar-products}: Interaction With Scalar Products}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-additive-inverses}: Interaction With Additive Inverses}%
    Omitted.

    \ProofBox{\cref{properties-of-infima-and-suprema-interaction-with-multiplicative-inverses}: Interaction With Multiplicative Inverses}%
    Omitted.
\end{Proof}
...
\begin{definition}{Dedekind Cuts}{dedekind-cuts}%
    ...
    \begin{enumerate}
        ...
        \item\label{dedekind-cuts-4}\SloganFont{Inexistence of a Greatest Element. }If $x\in A$, then there exists some $y\in A$ such that $x\lt y$.
...
\begin{remark}{Dual Axioms for Dedekind Cuts}{dual-axioms-for-dedekind-cuts}%
    ...
    \begin{enumerate}
        ...
        \item\label{dual-axioms-for-dedekind-cuts-3}\SloganFont{Upward-Closedness. }For each $x,y\in\Q$, if $x\lt y$ and $x\in B$, then $y\in B$.
        \item\label{dual-axioms-for-dedekind-cuts-4}\SloganFont{Inexistence of a Greatest Element. }If $x\in A$, then there exists some $y\in A$ such that $x\lt y$.
...
\begin{proposition}{Properties of the Dedekind Real Numbers}{properties-of-the-dedekind-real-numbers}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-the-dedekind-real-numbers-the-archimedean-property}\SloganFont{The Archimedean Property. }For each $x,y\in\R$, if $x,y\gt0$, then there exists some $n\in\N$ such that $nx\gt y$.
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-the-cauchy-real-numbers-multiplication}\SloganFont{Multiplication. }The Cauchy real numbers admit a multiplication operation given by
            \[
                ...
                [(a_{n}b_{n})_{n\in\N}].%
            \]%
        \item\label{properties-of-the-cauchy-real-numbers-rational-approximation}\SloganFont{Rational Approximation. }For each $x\in\R$ and each $\epsilon\gt0$, there exists some $a\in\Q$ such that we have
            \[
                \abs{x-\iota(a)}%
                \lt_{\R}%
                \epsilon.%
            \]%
        \item\label{properties-of-the-cauchy-real-numbers-the-archimedean-property}\SloganFont{The Archimedean Property. }For each $x,y\in\R$, if $x,y\gt0$, then there exists some $n\in\N$ such that $nx\gt y$.
                        ...
                        \item We then have
                            \begin{align*}
                                \abs{q_{n}-q_{m}} &=     \abs{(q_{n}-u_{n})+(u_{n}-u_{m})+(u_{m}-q_{m})}\\
                                                  ...
                                                  &\lt \frac{1}{n}+\frac{\epsilon}{3}+\frac{1}{m}\\
...
\begin{construction}{The Bourbaki Real Numbers}{the-bourbaki-real-numbers}%
    ...
    \]%
\end{construction}
\begin{definition}{The Relations $\lt_{\forall\exists}$ and $\lt_{\exists\forall}$}{the-relations-less-than-for-each-there-exists-and-less-than-there-exists-for-each}%
...
\begin{Proof}{Proof of \cref{lemmas-for-the-bourbaki-real-numbers}}%
    \FirstProofBox{\cref{lemmas-for-the-bourbaki-real-numbers-antisymmetry-of-less-than-for-each-there-exists}: Antisymmetry of The Relation $\lt_{\forall\exists}$}%
...
\begin{definition}{Sequences in $\R$}{sequences-in-r}%
    ...
    \begin{enumerate}
        \item\label{sequences-in-r-sequences-in-r}A \index[analysis]{sequence in R@sequence in $\R$}\textbf{sequence} in $\R$ is a map $\smash{(x_{n})_{n\in\N}\colon\N\to\R}$.
        \item\label{sequences-in-r-subsequences-in-r}A \index[analysis]{sequence in R@sequence in $\R$!subsequence of}\textbf{subsequence} of a sequence $\smash{(x_{n})_{n\in\N}\colon\N\to\R}$ is a pair $(f,(x_{f(n)})_{n\in\N})$ consisting of:
            \begin{itemize}
            ...
            \end{itemize}
        \item\label{sequences-in-r-convergence-of-sequences-in-r}A sequence $\smash{(x_{n})_{n\in\N}\colon\N\to\R}$ \textbf{converges} to a \index[analysis]{sequence in R@sequence in $\R$!limit of}\textbf{limit} $x\in\R$ if it satisfies the following condition:%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Terminology: }A sequence is \index[analysis]{sequence in R@sequence in $\R$!convergent}\textbf{convergent} if it converges to some $x\in\R$.
            }%
            %---  End Footnote  ---%
            %--- Begin Footnote ---%
            \footnote{%
                \SloganFont{Further Notation: }We write\index[notation]{limntoinfty@$\lim_{n\to\infty}$}%
                \[
                    x%
                    =%
                    \lim_{n\to\infty}(x_{n})%
        ...
        \item\label{properties-of-sequences-in-r-characterisations-of-convergence}\SloganFont{Characterisations of Convergence. }The following conditions are equivalent:
            \begin{enumerate}
                ...
                \item\label{properties-of-sequences-in-r-characterisations-of-convergence-b}We have%
                    ...
                    \]%
            \end{enumerate}
        \item\label{properties-of-sequences-in-r-bounded-monotone-sequences-are-convergent}\SloganFont{Bounded Monotone Sequences Are Convergent. }Let $(x_{n})_{n\in\N}$ be a sequence.
            \begin{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-sequences-in-r}}%
    ...
    \ProofBox{\cref{properties-of-sequences-in-r-bounded-monotone-sequences-are-convergent}: Bounded Monotone Sequences Are Convergent}%
...
\begin{definition}{Limit Inferior and Limit Superior}{limit-inferior-and-limit-superior}%
    ...
    \begin{enumerate}
        \item The \index[analysis]{sequence in R@sequence in $\R$!limit infimum of}\textbf{limit infimum} of $(x_{n})_{n\in\N}$ is the real number \index[notation]{liminfntoinftyxn@$\liminf_{n\to\infty}(x_{n})$}$\smash{\displaystyle\liminf_{n\to\infty}(x_{n})}$ defined by
            \[
                \liminf_{n\to\infty}(x_{n})%
                \defeq%
            ...
            \]%
        \item The \index[analysis]{sequence in R@sequence in $\R$!limit supremum of}\textbf{limit supremum} of $(x_{n})_{n\in\N}$ is the real number \index[notation]{limsupntoinftyxn@$\limsup_{n\to\infty}(x_{n})$}$\smash{\displaystyle\limsup_{n\to\infty}(x_{n})}$ defined by
            \[
                \limsup_{n\to\infty}(x_{n})%
                \defeq%
        ...
        \item\label{properties-of-sequences-in-r-characterisations-of-convergence}\SloganFont{Characterisations of Convergence. }The following conditions are equivalent:
            \begin{enumerate}
                ...
                \item We have%
                    ...
                    \]%
            \end{enumerate}
        \item\label{properties-of-sequences-in-r-interaction-with-order}\SloganFont{Interaction With Order. }Let $(x_{n})_{n\in\N}$ and $(y_{n})_{n\in\N}$ be sequences in $\R$.
            \begin{enumerate}
                ...
                \item\label{properties-of-sequences-in-r-interaction-with-order-b}If $x_{n}\leq y_{n}$ for each $n\in\N$, then we have
                    ...
                    \end{align*}
            \end{enumerate}
        \item\label{properties-of-sequences-in-r-interaction-with-subsequences}\SloganFont{Interaction With Subsequences. }There exists subsequences $\big(x_{f(n)}\big)_{n\in\N}$ and $\big(x_{g(n)}\big)_{n\in\N}$ of $(x_{n})_{n\in\N}$ with
            \begin{align*}
...
\begin{Proof}{Proof of \cref{properties-of-sequences-in-r}}%
    ...
    \ProofBox{\cref{properties-of-sequences-in-r-interaction-with-order}: Interaction With Order}%
    Omitted.

    \ProofBox{\cref{properties-of-sequences-in-r-interaction-with-subsequences}: Interaction With Subsequences}%
    Omitted.
    ...
    Omitted.
\end{Proof}
\section{The Surreal Numbers}\label{section-the-surreal-numbers}
\subsection{Foundations}\label{subsection-foundations}
\begin{construction}{The Class of Surreal Numbers}{the-class-of-surreal-numbers}%
    ...
    \[
        ...
        \to%
        \CatFont{U}% Class of all sets
    \]%
    where $S(\alpha)$ will be the set of \textbf{surreal numbers \say{created on day $\alpha$}}.
    \begin{enumerate}
        \item\label{the-class-of-surreal-numbers-the-universe-of-prior-forms}\SloganFont{The Universe of Prior Forms. }Given $S_{<\alpha}\defeq S\upharpoonright_{\alpha}$, we define the \textbf{universe of forms \say{prior to day $\alpha$}} to be the set $U_{<\alpha}$ defined by
            \[
                U_{<\alpha}
                \defeq%
                \bigcup_{\beta<\alpha}S(\beta).%
            \]%
        \item\label{the-class-of-surreal-numbers-the-set-of-forms-for-day-alpha}\SloganFont{The Set of Forms for Day $\alpha$. }Given $\alpha\in\Ord$, we define $S(\alpha)$ to be the set
            \[
                S(\alpha)%
                \defeq%
                \{%
            ...
            That is:
            \begin{enumerate}
                \item\label{the-class-of-surreal-numbers-the-set-of-forms-for-day-alpha-subset-condition}\SloganFont{Subset Condition. }The elements of $X_{L}$ and $X_{R}$ belong to the universe $U_{<\alpha}$ of forms prior to day $\alpha$.
                \item\label{the-class-of-surreal-numbers-the-set-of-forms-for-day-alpha-ordering}\SloganFont{Ordering. }The elements of $X_{L}$ are smaller than the elements of $X_{R}$.
            \end{enumerate}
    \end{enumerate}
...
\subsection{Finite Day Surreal Numbers}\label{subsection-finite-day-surreal-numbers}
\begin{definition}{The $k$th Day Surreal Numbers}{the-kth-day-surreal-numbers}%
    ...
    \begin{enumerate}
        ...
        \item\label{the-kth-day-surreal-numbers-kth-day-surreal-prenumbers}A \textbf{$k$th day surreal prenumber} is a pair $X\defeq(X_{L},X_{R})$ consisting of:
            \begin{itemize}
                \item A set $X_{L}$, called the \index[real-analysis]{surreal number!left set}\textbf{left set of $X$}, whose elements are $(k-1)$th day surreal numbers.
                \item A set $X_{R}$, called the \index[real-analysis]{surreal number!right set}\textbf{right set of $X$}, whose elements are $(k-1)$th day surreal numbers.
            \end{itemize}
            satisfying the following conditions:
            \begin{enumerate}
                \item\label{the-kth-day-surreal-numbers-kth-day-surreal-numbers-empty-intersection}\SloganFont{Empty Intersection. }We have $X_{L}\cap X_{R}=\emptyset$.
                \item\label{the-kth-day-surreal-numbers-kth-day-surreal-numbers-ordering}\SloganFont{Ordering. }For each $x_{L}\in X_{L}$ and each $x_{R}\in X_{R}$, we have $x_{L}\leq x_{R}$, where $\leq$ is the order of \cref{the-kth-day-surreal-numbers-the-order-on-kth-day-surreal-pre-numbers}
            \end{enumerate}
