...
\begin{Proof}{Proof of \cref{properties-of-monoidal-categories}}%
    ...
    We claim that \cref{properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-a,properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-2,properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-c} are equivalent.
    ...
    \begin{webcompile}
        ...
        \end{tikzcd}
    \end{webcompile}
    These commute by the naturality of the left unitor of $\CatFont{C}$. Since $\LUnitor^{\CatFont{C}}_{A}$ and $\LUnitor^{\CatFont{C}}_{B}$ are invertible and $\id_{\Unit_{\CatFont{C}}}\otimes_{\CatFont{C}}f=\id_{\Unit_{\CatFont{C}}}\otimes_{\CatFont{C}}g$, it follows that $f=g$.
    ...
    \begin{webcompile}
        ...
        \end{tikzcd}
    \end{webcompile}
    These commute by the naturality of the right unitor of $\CatFont{C}$. Since $\RUnitor^{\CatFont{C}}_{A}$ and $\RUnitor^{\CatFont{C}}_{B}$ are invertible and $f\otimes_{\CatFont{C}}\id_{\Unit_{\CatFont{C}}}=g\otimes_{\CatFont{C}}\id_{\Unit_{\CatFont{C}}}$, it follows that $f=g$.
