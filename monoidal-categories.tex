...
\begin{definition}{Monoidal Categories}{monoidal-categories}%
    A \index[categories]{monoidal category}\textbf{monoidal category} is a pseudomonoid $\smash{(\CatFont{C},\otimes,\Unit,\alpha,\LUnitor,\RUnitor)}$ in $(\TwoCategoryOfCategories,\times,\PunctualCategory)$.%
\end{definition}
\begin{remark}{Unwinding \cref{monoidal-categories}}{unwinding-monoidal-categories}%
    ...
    %--- Begin Footnote ---%
    \footnote{%
        \SloganFont{Further Notation: }When working with more than one monoidal category, we may employ additional notation to differentiate each of the monoidal categories in question, such as:
        \begin{itemize}
...
\begin{Proof}{Proof of \cref{properties-of-monoidal-categories}}%
    ...
    \begin{scalemath}
        \begin{tikzcd}[row sep={0*\the\DL,between origins}, column sep={0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
            ...
            % Subdiagrams
            \arrow[from=2-2,to=2-6, phantom, "\scriptstyle(1)", xshift=-0.335\ThreeCmPlusAQuarter, yshift=-0.15\ThreeCmPlusAQuarter]
            \arrow[from=2-2,to=2-6, phantom, "\scriptstyle(2)", xshift=+0.3\ThreeCmPlusAQuarter, yshift=-0.35\ThreeCmPlusAQuarter]
            \arrow[from=3-3,to=3-5, phantom, "(3)", xshift=-1.0\ThreeCmPlusAQuarter]
            \arrow[from=3-3,to=3-5, phantom, "(4)", xshift=+1.0\ThreeCmPlusAQuarter]
            \arrow[from=3-3,to=3-5, phantom, "(5)", yshift=-0.65\ThreeCmPlusAQuarter]
        \end{tikzcd}
