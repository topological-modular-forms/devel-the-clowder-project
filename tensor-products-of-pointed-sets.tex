...
\begin{Proof}{Proof of the Equivalence in \cref{unwinding-tensors-of-pointed-sets-by-sets}}%
    ...
    \begin{itemize}
        \item A map
            ...
            \begin{align*}
                \xi^{\dagger}(a,x_{0}) &\eqdef \xi_{a}(x_{0})\\%
                                       &\eqdef k_{0}%
            \end{align*}
        ...
        \item Conversely, a map
            ...
            \begin{align*}
                \xi^{\dagger}_{a}(x_{0}) &\eqdef \xi(a,x_{0})\\%
                                         &\eqdef k_{0}.%
            \end{align*}
    \end{itemize}
...
\begin{notation}{Elements of Tensors of Pointed Sets by Sets}{elements-of-tensors-of-pointed-sets-by-sets}%
    ...
    \begin{align*}
        A\odot X &\cong  \bigvee_{a\in A}(X,x_{0})\\%
                 &\eqdef (\coprod_{i\in I}X_{i})/\unsim.%
    \end{align*}
\end{notation}
...
\begin{Proof}{Proof of \cref{construction-of-tensors-of-pointed-sets-by-sets}}%
    ...
    \begin{enumerate}
        \item\label{proof-of-construction-of-tensors-of-pointed-sets-by-sets-1}\SloganFont{Map \rmI. }We define a map
            ...
            \begin{align*}
                \xi_{a}(x_{0}) &\eqdef \xi(a\odot x_{0})\\%
                               &=      k_{0},%
            \end{align*}
        ...
        \item\label{proof-of-construction-of-tensors-of-pointed-sets-by-sets-2}\SloganFont{Map \rmII. }We define a map
            ...
            \begin{align*}
                \xi^{\dagger}(a\odot x_{0}) &\eqdef \xi_{a}(x_{0})\\%
                                            &=      k_{0},
            \end{align*}
        ...
        \item\label{proof-of-construction-of-tensors-of-pointed-sets-by-sets-3}\SloganFont{Invertibility \rmI. }We claim that
            ...
            we have
            \begin{align*}
                [\Psi_{K}\circ\Phi_{K}](\xi) &\eqdef \Psi_{K}(\Phi_{K}(\xi))\\%
                                             &\eqdef \Psi_{K}(\llbracket a\mapsto\llbracket x\mapsto\xi(a\odot x)\rrbracket\rrbracket)\\%
                                             &\eqdef \Psi_{K}(\llbracket a'\mapsto\llbracket x'\mapsto\xi(a'\odot x')\rrbracket\rrbracket)\\%
                                             &\eqdef \llbracket a\odot x\mapsto\ev_{x}(\ev_{a}(\llbracket a'\mapsto\llbracket x'\mapsto\xi(a'\odot x')\rrbracket\rrbracket))\rrbracket\\%
                                             &\eqdef \llbracket a\odot x\mapsto\ev_{x}(\llbracket x'\mapsto\xi(a\odot x')\rrbracket)\rrbracket\\%
                                             &\eqdef \llbracket a\odot x\mapsto\xi(a\odot x)\rrbracket\\%
                                             &\eqdef \xi.%
            \end{align*}
        \item\label{proof-of-construction-of-tensors-of-pointed-sets-by-sets-4}\SloganFont{Invertibility \rmII. }We claim that
            ...
            \begin{align*}
                [\Phi_{K}\circ\Psi_{K}](\xi) &\eqdef \Phi_{K}(\Psi_{K}(\xi))\\%
                                             &\eqdef \Phi_{K}(\llbracket a\odot x\mapsto\xi_{a}(x)\rrbracket)\\%
                                             &\eqdef \llbracket a\mapsto\llbracket x\mapsto\xi_{a}(x)\rrbracket\rrbracket\\
                                             &\eqdef \llbracket a\mapsto\xi(a)\rrbracket\\
                                             &\eqdef \xi.%
            \end{align*}
        \item\label{proof-of-construction-of-tensors-of-pointed-sets-by-sets-5}\SloganFont{Naturality of $\Phi$. }We need to show that, given a morphism of pointed sets
            ...
            we have
            \begin{align*}
                [\Phi_{K'}\circ\phi_{*}](\xi) &\eqdef \Phi_{K'}(\phi_{*}(\xi))\\
                                              &\eqdef \Phi_{K'}(\phi\circ\xi)\\
                                              &\eqdef (\phi\circ\xi)^{\dagger}\\
                                              &\eqdef \llbracket a\mapsto\phi\circ\xi(a\odot-)\rrbracket\\
                                              &\eqdef \llbracket a\mapsto\phi_{*}(\xi(a\odot-))\rrbracket\\
                                              &\eqdef (\phi_{*})_{*}(\llbracket a\mapsto\xi(a\odot-\rrbracket))\\
                                              &\eqdef (\phi_{*})_{*}(\Phi_{K}(\xi))\\
                                              &\eqdef [(\phi_{*})_{*}\circ\Phi_{K}](\xi).
            \end{align*}
...
\begin{Proof}{Proof of \cref{construction-of-cotensors-of-pointed-sets-by-sets}}%
    ...
    \begin{enumerate}
        ...
        \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-2}\SloganFont{Map \rmII. }We define a map
            ...
            \begin{align*}
                \xi^{\dagger}(k_{0}) &\eqdef [(\xi_{a}(k_{0}))_{a\in A}]\\%
                                     &=      x_{0},
            \end{align*}
        ...
        \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-3}\SloganFont{Invertibility \rmI. }We claim that
            ...
            \begin{align*}
                [\Psi_{K}\circ\Phi_{K}](\xi) &\eqdef \Psi_{K}(\Phi_{K}(\xi))\\%
                                             &\eqdef \Psi_{K}(\llbracket a\mapsto\xi_{a}\rrbracket)\\%
                                             &\eqdef \Psi_{K}(\llbracket a'\mapsto\xi_{a'}\rrbracket)\\%
                                             &\eqdef \llbracket k\mapsto[(\ev_{a}(\llbracket a'\mapsto\xi_{a'}(k)\rrbracket))_{a\in A}]\rrbracket\\%
                                             &\eqdef \llbracket k\mapsto[(\xi_{a}(k))_{a\in A}]\rrbracket.%
            \end{align*}
            Now, we have two cases:
            \begin{enumerate}
                \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-3a}If $\xi(k)=[(x_{0})_{a\in A}]$, we have
                    \begin{align*}
                        [\Psi_{K}\circ\Phi_{K}](\xi) &\eqdef \llbracket k\mapsto[(\xi_{a}(k))_{a\in A}]\rrbracket\\%
                                                     &\eqdef \llbracket k\mapsto[(x_{0})_{a\in A}]\rrbracket\\%
                                                     &\eqdef \llbracket k\mapsto\xi(k)\rrbracket\\%
                                                     &\eqdef \xi.%
                    \end{align*}
                \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-3b}If $\xi(k)\neq [(x_{0})_{a\in A}]$ and $\xi(k)=[(x^{k}_{a})_{a\in A}]$ instead, we have
                    \begin{align*}
                        [\Psi_{K}\circ\Phi_{K}](\xi) &\eqdef \llbracket k\mapsto[(\xi_{a}(k))_{a\in A}]\rrbracket\\%
                                                     &\eqdef \llbracket k\mapsto[(x^{k}_{a})_{a\in A}]\rrbracket\\%
                                                     &\eqdef \llbracket k\mapsto\xi(k)\rrbracket\\%
                                                     &\eqdef \xi.%
                    \end{align*}
            \end{enumerate}
        ...
        \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-4}\SloganFont{Invertibility \rmII. }We claim that
            ...
            \begin{align*}
                [\Phi_{K}\circ\Psi_{K}](\xi) &\eqdef \Phi_{K}(\Psi_{K}(\xi))\\%
                                             &\eqdef \Phi_{K}(\llbracket k\mapsto[(\xi_{a}(k))_{a\in A}]\rrbracket)\\%
                                             &\eqdef \llbracket a\mapsto\llbracket k\mapsto\xi_{a}(k)\rrbracket\rrbracket\\%
                                             &\eqdef \xi%
            \end{align*}
        \item\label{proof-of-construction-of-cotensors-of-pointed-sets-by-sets-5}\SloganFont{Naturality of $\Psi$. }We need to show that, given a morphism of pointed sets
            ...
            we have
            \begin{align*}
                [\Psi_{K}\circ(\phi^{*})_{*}](\xi) &\eqdef \Psi_{K}((\phi^{*})_{*}(\xi))\\
                                                   &\eqdef \Psi_{K}((\phi^{*})_{*}(\llbracket a\mapsto\xi_{a}\rrbracket))\\
                                                   &\eqdef \Psi_{K}((\llbracket a\mapsto\phi^{*}(\xi_{a})\rrbracket))\\
                                                   &\eqdef \Psi_{K}((\llbracket a\mapsto\llbracket k\mapsto\xi_{a}(\phi(k))\rrbracket\rrbracket))\\
                                                   &\eqdef \llbracket k\mapsto[(\xi_{a}(\phi(k)))_{a\in A}]\rrbracket\\
                                                   &\eqdef \phi^{*}(\llbracket k'\mapsto[(\xi_{a}(k'))_{a\in A}]\rrbracket)\\
                                                   &\eqdef \phi^{*}(\Psi_{K'}(\xi))\\
                                                   &\eqdef [\phi^{*}\circ\Psi_{K'}](\xi).
            \end{align*}
...
\begin{definition}{The Left Skew Associator of $\lhd$}{the-left-skew-associator-of-the-left-tensor-product-of-pointed-sets}%
    ...
    \begin{align*}
        (X\lhd Y)\lhd Z &\eqdef |Z|\odot(X\lhd Y)\\
                        &\eqdef |Z|\odot(|Y|\odot X)\\
...
\begin{remark}{Unwinding \cref{the-left-skew-associator-of-the-left-tensor-product-of-pointed-sets}}{unwinding-the-left-skew-associator-of-the-left-tensor-product-of-pointed-sets}%
    ...
    \begin{align*}
        [(z,[(y,x)])] &\eqdef [(z,x\lhd y)]\\
                      &\eqdef (x\lhd y)\lhd z
    \end{align*}
    and
    \begin{align*}
        [([(z,y)],x)] &\eqdef [(y\lhd z,x)]\\
                      &\eqdef x\lhd(y\lhd z).
    \end{align*}
...
\begin{remark}{Unwinding \cref{the-left-skew-left-unitor-of-the-left-tensor-product-of-pointed-sets}}{unwinding-the-left-skew-left-unitor-of-the-left-tensor-product-of-pointed-sets}%
    ...
    \begin{align*}
        \LUnitor^{\Sets_{*},\lhd}_{X}(0\lhd x) &\eqdef x_{0},\\%
        \LUnitor^{\Sets_{*},\lhd}_{X}(1\lhd x) &\eqdef x%
    \end{align*}
...
\begin{remark}{Non-Invertibility of the Skew Left Unitor of $\lhd$}{non-invertibility-of-the-left-skew-left-unitor-of-the-left-tensor-product-of-pointed-sets}%
    ...
    \begin{align*}
        [\LUnitor^{\Sets_{*},\lhd}_{X}\circ\phi](x) &\eqdef \LUnitor^{\Sets_{*},\lhd}_{X}(\phi(x))\\
                                                    &\eqdef \LUnitor^{\Sets_{*},\lhd}_{X}(1\lhd x)\\
                                                    &\eqdef x\\
                                                    &\eqdef [\id_{X}](x)
    \end{align*}
    so that
    ...
    and
    \begin{align*}
        [\phi\circ\LUnitor^{\Sets_{*},\lhd}_{X}](1\lhd x) &\eqdef \phi(\LUnitor^{\Sets_{*},\lhd}_{X}(1\lhd x))\\
                                                          &\eqdef \phi(x)\\
                                                          &\eqdef 1\lhd x\\
                                                          &\eqdef [\id_{S^{0}\lhd X}](1\lhd x),
    \end{align*}
    but
    \begin{align*}
        [\phi\circ\LUnitor^{\Sets_{*},\lhd}_{X}](0\lhd x) &\eqdef \phi(\LUnitor^{\Sets_{*},\lhd}_{X}(0\lhd x))\\
                                                          &\eqdef \phi(x_{0})\\
                                                          &\eqdef 1\lhd x_{0},
    \end{align*}
    where $0\lhd x\neq1\lhd x_{0}$. Thus
...
\begin{Proof}{Proof of \cref{the-left-skew-right-unitor-of-the-left-tensor-product-of-pointed-sets}}%
    ...
    is indeed a morphism of pointed sets as we have
    \begin{align*}
        \RUnitor^{\Sets_{*},\lhd}_{X}(x_{0}) &\eqdef x_{0}\lhd1\\%
                                             &=      x_{0}\lhd0.%
    \end{align*}
...
\begin{Proof}{Proof of \cref{constructions-of-the-right-tensor-product-of-pointed-sets}}%
    ...
    \begin{envsmallsize}
        \[
            ...
            \defeq%
            \{%
                f\in\Hom_{\Sets}\left(\coprod_{x\in X}Y,Z\right)%
                \ \middle|\ %
                \begin{aligned}
                    &\text{for each $x,y\in X$, if}\\
...
\begin{definition}{The Right Skew Associator of $\rhd$}{the-right-skew-associator-of-the-right-tensor-product-of-pointed-sets}%
    ...
    at $(X,x_{0}),(Y,y_{0}),(Z,z_{0})\in\Obj(\Sets_{*})$ is given by
    \begin{align*}
        X\rhd(Y\rhd Z) &\eqdef \abs{X}\odot(Y\rhd Z)\\
                       &\eqdef \abs{X}\odot(|Y|\odot Z)\\
                       &\cong  \bigvee_{x\in X}(|Y|\odot Z)\\
                       &\cong  \bigvee_{x\in X}(\bigvee_{y\in Y}Z)\\
                       &\to    \bigvee_{[(x,y)]\in\bigvee_{x\in X}Y}Z\\
                       &\cong  \bigvee_{[(x,y)]\in\abs{X}\odot Y}Z\\%
                       &\cong  |\abs{X}\odot Y|\odot Z\\%
                       &\eqdef |X\rhd Y|\odot Z\\%
                       &\eqdef (X\rhd Y)\rhd Z,%
    \end{align*}
    where the map%
    \[
...
\begin{remark}{Unwinding \cref{the-right-skew-associator-of-the-right-tensor-product-of-pointed-sets}}{unwinding-the-right-skew-associator-of-the-right-tensor-product-of-pointed-sets}%
    Unwinding the notation for elements, we have
    \begin{align*}
        [(x,[(y,z)])] &\eqdef [(x,y\rhd z)]\\
                      &\eqdef x\rhd(y\rhd z)
    \end{align*}
    and
    \begin{align*}
        [([(x,y)],z)] &\eqdef [(x\rhd y,z)]\\
                      &\eqdef (x\rhd y)\rhd z.
    \end{align*}
...
\begin{remark}{Unwinding \cref{the-right-skew-right-unitor-of-the-right-tensor-product-of-pointed-sets}}{unwinding-the-right-skew-right-unitor-of-the-right-tensor-product-of-pointed-sets}%
    ...
    \begin{align*}
        \RUnitor^{\Sets_{*},\rhd}_{X}(x\rhd 0) &\eqdef x_{0},\\%
        \RUnitor^{\Sets_{*},\rhd}_{X}(x\rhd 1) &\eqdef x%
    \end{align*}
...
\begin{remark}{Non-Invertibility of the Skew Right Unitor of $\rhd$}{non-invertibility-of-the-right-skew-right-unitor-of-the-right-tensor-product-of-pointed-sets}%
    ...
    for each $x\in X$. Indeed, we have
    \begin{align*}
        [\RUnitor^{\Sets_{*},\rhd}_{X}\circ\phi](x) &\eqdef \RUnitor^{\Sets_{*},\rhd}_{X}(\phi(x))\\
                                                    &\eqdef \RUnitor^{\Sets_{*},\rhd}_{X}(x\rhd 1)\\
                                                    &\eqdef x\\
                                                    &\eqdef [\id_{X}](x)
    \end{align*}
    so that
    ...
    and
    \begin{align*}
        [\phi\circ\RUnitor^{\Sets_{*},\rhd}_{X}](x\rhd 1) &\eqdef \phi(\RUnitor^{\Sets_{*},\rhd}_{X}(x\rhd 1))\\
                                                          &\eqdef \phi(x)\\
                                                          &\eqdef x\rhd 1\\
                                                          &\eqdef [\id_{X\rhd S^{0}}](x\rhd 1),
    \end{align*}
    but
    \begin{align*}
        [\phi\circ\RUnitor^{\Sets_{*},\rhd}_{X}](x\rhd 0) &\eqdef \phi(\RUnitor^{\Sets_{*},\rhd}_{X}(x\rhd 0))\\
                                                          &\eqdef \phi(x_{0})\\
                                                          &\eqdef 1\rhd x_{0},
    \end{align*}
    where $x\rhd 0\neq1\rhd x_{0}$. Thus
...
\begin{Proof}{Proof of \cref{properties-of-smash-products-of-pointed-sets}}%
    ...
    \begin{enumerate}
        ...
        \item\label{proof-of-properties-of-smash-products-of-pointed-sets-functoriality-4}If $x=x_{0}$ and $x'=x_{0}$, we have 
            \begin{align*}
                [f\wedge g](x_{0},y) &\eqdef f(x_{0})\wedge g(y)\\%
                                     &=      a_{0}\wedge g(y)\\%
                                     &=      a_{0}\wedge g(y')\\%
                                     &=      f(x_{0})\wedge g(y')\\%
                                     &\eqdef [f\wedge g](x_{0},y').%
            \end{align*}
    ...
    \begin{itemize}
        \item\SloganFont{Preservation of Identities. }We have
            \begin{align*}
                [\id_{X}\wedge\id_{Y}](x\wedge y) &\eqdef \id_{X}(x)\wedge\id_{Y}(y)\\
                                                  &=      x\wedge y\\
        ...
        \item\SloganFont{Preservation of Composition. }Given pointed maps
            ...
            we have
            \begin{align*}
                [(h\circ f)\wedge(k\circ g)](x\wedge y) &\eqdef h(f(x))\wedge k(g(y))\\
                                                        &\eqdef [h\wedge k](f(x)\wedge g(y))\\
                                                        &\eqdef [h\wedge k]([f\wedge g](x\wedge y))\\
                                                        &\eqdef [(h\wedge k)\circ(f\wedge g)](x\wedge y)
            \end{align*}
            for each $x\wedge y\in X\wedge Y$, and thus
            \[
        ...
        \item A map
            ...
            \begin{itemize}
                \item The map $\xi^{\dagger}$ is indeed pointed, as we have
                    \begin{align*}
                        \xi^{\dagger}_{x_{0}}(y) &\eqdef \xi(x_{0},y)\\%
                                                 &\eqdef z_{0}%
                    \end{align*}
                ...
                \item The map $\xi^{\dagger}_{x}$ indeed lies in $\eSets_{*}(Y,Z)$, as we have%
                    \begin{align*}
                        \xi^{\dagger}_{x}(y_{0}) &\eqdef \xi(x,y_{0})\\%
                                                 &\eqdef z_{0}.%
                    \end{align*}
            \end{itemize}
        \item Conversely, a map
            ...
            \begin{itemize}
                \item\SloganFont{Left Bilinearity. }We have
                    \begin{align*}
                        \xi^{\dagger}(x_{0},y) &\eqdef \xi_{x_{0}}(y)\\%
                                               &\eqdef \Delta_{z_{0}}(y)\\%
                                               &\eqdef z_{0}%
                    \end{align*}
                ...
                \item\SloganFont{Right Bilinearity. }We have
                    \begin{align*}
                        \xi^{\dagger}(x,y_{0}) &\eqdef \xi_{x}(y_{0})\\%
                                               &\eqdef z_{0}%
                    \end{align*}
    ...
    \begin{itemize}
        ...
        \item\SloganFont{The Basepoint. }The element%
            \[%
                ...
                (Y,y_{0})%
            \]%
            of $\Sets_{*}((X,x_{0}),(Y,y_{0}))$ defined by
            \[
                \Delta_{y_{0}}(x)%
                \defeq%
                y_{0}%
...
\begin{definition}{The Associator of $\wedge$}{the-associator-of-the-smash-product-of-pointed-sets}%
    ...
    \[
        ...
        X\wedge(Y\wedge Z)
    \]%
    at $(X,x_{0}),(Y,y_{0}),(Z,z_{0})\in\Obj(\Sets_{*})$ is defined by
    \[
...
\begin{Proof}{Proof of \cref{properties-of-the-diagonal-of-the-smash-product-of-pointed-sets}}%
    ...
    \begin{enumerate}
        ...
        \item\label{proof-of-properties-of-the-diagonal-of-the-smash-product-of-pointed-sets-monoidality-2}\SloganFont{\cref{properties-of-the-diagonal-of-the-smash-product-of-pointed-sets-monoidality-compatibility-with-strong-unitality-constraints}: Compatibility With Strong Unitality Constraints: }As shown in the proof of \cref{the-left-unitor-of-the-smash-product-of-pointed-sets}, the inverse of the left unitor of $\Sets_{*}$ with respect to to the smash product of pointed sets at $(X,x_{0})\in\Obj(\Sets_{*})$ is given by
            ...
            \begin{align*}
                \LUnitor^{\Sets_{*},-1}_{S^{0}}(0) &\eqdef 1\wedge0,\\
                \LUnitor^{\Sets_{*},-1}_{S^{0}}(1) &\eqdef 1\wedge1.
            \end{align*}
            But since $1\wedge0=0\wedge0$ and
            \begin{align*}
                \Delta^{\wedge}_{S^{0}}(0) &\eqdef 0\wedge0,\\
                \Delta^{\wedge}_{S^{0}}(1) &\eqdef 1\wedge1,
            \end{align*}
...
\begin{Proof}{Proof of \cref{the-universal-property-of-sets-star-smash-s-zero}}%
    ...
    \begin{itemize}
        ...
        \item Subdiagram $(4)$ commutes by \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-tensoring-right-unitors-with-identities} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-tensoring-right-unitors-with-identities} of \cref{properties-of-monoidal-categories}}.
        \item Subdiagram $(5)$ commutes by the naturality of $\RUnitor^{\Sets_{*},-1}$.
        \item Subdiagram $(6)$ commutes trivially.
        \item Subdiagram $(7)$ commutes by the naturality of $\RUnitor^{\Sets_{*}}$, where the equality $\RUnitor^{\Sets_{*}}_{S^{0}}=\LUnitor^{\Sets_{*}}_{S^{0}}$ comes from \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{properties-of-monoidal-categories}}.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Subdiagram  $(6)$ commutes by the naturality of $\RUnitor'$, where the equality $\RUnitor'_{\Unit_{\Sets_{*}}}=\LUnitor'_{\Unit_{\Sets_{*}}}$ comes from \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{properties-of-monoidal-categories}};
    \end{itemize}
    ...
    \begin{scalemath}
        ...
        \end{tikzcd}
    \end{scalemath}
    whose boundary diagram corresponds to the diagram $(\dagger)$ above, since the composition in \textcolor{OIvermillion}{red} is equal to $\sigma'_{S^{0},\Unit_{\Sets_{*}}}$ as proved above, and then the composition in \textcolor{OIvermillion}{red} composed with $\LUnitor'_{S^{0}}$ is equal to $\RUnitor'_{S^{0}}$ by \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{properties-of-monoidal-categories}}. In this diagram:
    \begin{itemize}
        \item Subdiagrams $(1)$, $(2)$, and $(3)$ commute by the naturality of $\id^{\otimes}_{\Sets_{*}}$.
        \item Subdiagrams $(4)$, $(5)$, and $(6)$ commute by the naturality of $\LUnitor^{\Sets_{*}}$, where the equality $\LUnitor^{\Sets_{*}}_{S^{0}}=\RUnitor^{\Sets_{*}}_{S^{0}}$ comes from \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-coherence-for-left-and-right-unitors-of-the-monoidal-unit} of \cref{properties-of-monoidal-categories}}.
    \end{itemize}
    Since all subdiagrams commute, so does the boundary diagram, i.e.\ the diagram $(\dagger)$ above. As a result, the diagram
    \[
        \begin{tikzcd}[row sep={0.0*\the\DL,between origins}, column sep={0.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
    ...
    \begin{itemize}
        ...
        \item Subdiagram  $(6)$ commutes by \ChapterRef{\ChapterMonoidalCategories, \cref{monoidal-categories:properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-tensoring-right-unitors-with-identities} of \cref{monoidal-categories:properties-of-monoidal-categories}}{\cref{properties-of-monoidal-categories-cancellation-of-identities-in-a-monoidal-category-tensoring-right-unitors-with-identities} of \cref{properties-of-monoidal-categories}};
