...
\begin{Proof}{Proof of the Claims Made in \cref{the-associator-of-the-product-of-sets}}%
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\alpha^{\Sets,-1}_{X,Y,Z}\circ\alpha^{\Sets}_{X,Y,Z}]((x,y),z) &\eqdef \alpha^{\Sets,-1}_{X,Y,Z}(\alpha^{\Sets}_{X,Y,Z}((x,y),z))\\
                                                                                &\eqdef \alpha^{\Sets,-1}_{X,Y,Z}(x,(y,z))\\
                                                                                &\eqdef ((x,y),z)\\
                                                                                &\eqdef [\id_{(X\times Y)\times Z}]((x,y),z)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\alpha^{\Sets}_{X,Y,Z}\circ\alpha^{\Sets,-1}_{X,Y,Z}](x,(y,z)) &\eqdef \alpha^{\Sets}_{X,Y,Z}(\alpha^{\Sets,-1}_{X,Y,Z}(x,(y,z)))\\
                                                                                &\eqdef \alpha^{\Sets}_{X,Y,Z}((x,y),z)\\
                                                                                &\eqdef (x,(y,z))\\
                                                                                &\eqdef [\id_{(X\times Y)\times Z}](x,(y,z))
            \end{align*}
            for each $(x,(y,z))\in X\times(Y\times Z)$, and therefore we have
...
\begin{definition}{The Left Unitor of $\times$}{the-left-unitor-of-the-product-of-sets}%
    ...
    \[
        ...
        X
    \]%
    at $X\in\Obj(\Sets)$ is defined by
    \[
...
\begin{Proof}{Proof of the Claims Made in \cref{the-left-unitor-of-the-product-of-sets}}%
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\LUnitor^{\Sets,-1}_{X}\circ\LUnitor^{\Sets}_{X}](\pt,x) &\eqdef \LUnitor^{\Sets,-1}_{X}(\LUnitor^{\Sets}_{X}(\pt,x))\\
                                                                          &\eqdef \LUnitor^{\Sets,-1}_{X}(x)\\
                                                                          &\eqdef (\pt,x)\\
                                                                          &\eqdef [\id_{\pt\times X}](\pt,x)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\LUnitor^{\Sets}_{X}\circ\LUnitor^{\Sets,-1}_{X}](x) &\eqdef \LUnitor^{\Sets}_{X}(\LUnitor^{\Sets,-1}_{X}(x))\\
                                                                      &\eqdef \LUnitor^{\Sets,-1}_{X}(\pt,x)\\
                                                                      &\eqdef x\\
                                                                      &\eqdef [\id_{X}](x)
            \end{align*}
...
\begin{Proof}{Proof of the Claims Made in \cref{the-right-unitor-of-the-product-of-sets}}%
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\RUnitor^{\Sets,-1}_{X}\circ\RUnitor^{\Sets}_{X}](x,\point) &\eqdef \RUnitor^{\Sets,-1}_{X}(\RUnitor^{\Sets}_{X}(x,\point))\\
                                                                             &\eqdef \RUnitor^{\Sets,-1}_{X}(x)\\
                                                                             &\eqdef (x,\point)\\
                                                                             &\eqdef [\id_{X\times\pt}](x,\point)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\RUnitor^{\Sets}_{X}\circ\RUnitor^{\Sets,-1}_{X}](x) &\eqdef \RUnitor^{\Sets}_{X}(\RUnitor^{\Sets,-1}_{X}(x))\\
                                                                      &\eqdef \RUnitor^{\Sets,-1}_{X}(x,\point)\\
                                                                      &\eqdef x\\
                                                                      &\eqdef [\id_{X}](x)
            \end{align*}
            for each $x\in X$, and therefore we have
...
\begin{Proof}{Proof of the Claims Made in \cref{the-symmetry-of-the-product-of-sets}}%
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\sigma^{\Sets,-1}_{X,Y}\circ\sigma^{\Sets}_{X,Y}](x,y) &\eqdef \sigma^{\Sets,-1}_{X,Y}(\sigma^{\Sets}_{X,Y}(x,y))\\
                                                                        &\eqdef \sigma^{\Sets,-1}_{X,Y}(y,x)\\
                                                                        &\eqdef (x,y)\\
                                                                        &\eqdef [\id_{X\times Y}](x,y)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\sigma^{\Sets}_{X,Y}\circ\sigma^{\Sets,-1}_{X,Y}](y,x) &\eqdef \sigma^{\Sets,-1}_{X,Y}(\sigma^{\Sets}_{X,Y}(y,x))\\
                                                                        &\eqdef \sigma^{\Sets,-1}_{X,Y}(x,y)\\
                                                                        &\eqdef (y,x)\\
                                                                        &\eqdef [\id_{Y\times X}](y,x)
            \end{align*}
...
\begin{Proof}{Proof of the Claims Made in \cref{the-associator-of-the-coproduct-of-sets}}%
    ...
    \begin{align*}
        (X\icoprod Y)\icoprod Z &\eqdef        \{(0,a)\in S\ \middle|\ a\in X\icoprod Y\}\cup\{(1,z)\in S\ \middle|\ z\in Z\}\\
    ...
    \begin{align*}
        X\icoprod(Y\icoprod Z)  &\eqdef \{(0,x)\in S'\ \middle|\ x\in X\}\cup\{(1,a)\in S'\ \middle|\ a\in Y\icoprod Z\}\\
...
\begin{Proof}{Proof of the Claims Made in \cref{the-left-unitor-of-the-coproduct-of-sets}}%
    ...
    \begin{align*}
        \emptyset\icoprod X &\eqdef \{(0,z)\in S\ \middle|\ z\in\emptyset\}\cup\{(1,x)\in S\ \middle|\ x\in X\}\\
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\LUnitor^{\Sets,\icoprod,-1}_{X}\circ\LUnitor^{\Sets,\icoprod}_{X}](1,x) &\eqdef \LUnitor^{\Sets,\icoprod,-1}_{X}(\LUnitor^{\Sets,\icoprod}_{X}(1,x))\\
                                                                                          &\eqdef \LUnitor^{\Sets,\icoprod,-1}_{X}(x)\\
                                                                                          &\eqdef (1,x)\\
                                                                                          &\eqdef [\id_{\emptyset\icoprod X}](1,x)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\LUnitor^{\Sets,\icoprod}_{X}\circ\LUnitor^{\Sets,\icoprod,-1}_{X}](x) &\eqdef \LUnitor^{\Sets,\icoprod}_{X}(\LUnitor^{\Sets,\icoprod,-1}_{X}(x))\\
                                                                                        &\eqdef \LUnitor^{\Sets,\icoprod,-1}_{X}(1,x)\\
                                                                                        &\eqdef x\\
                                                                                        &\eqdef [\id_{X}](x)
            \end{align*}
            for each $x\in X$, and therefore we have
...
\begin{Proof}{Proof of the Claims Made in \cref{the-right-unitor-of-the-coproduct-of-sets}}%
    ...
    \begin{align*}
        X\icoprod\emptyset  &\eqdef \{(0,x)\in S\ \middle|\ x\in X\}\cup\{(1,z)\in S\ \middle|\ z\in\emptyset\}\\
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\RUnitor^{\Sets,\icoprod,-1}_{X}\circ\RUnitor^{\Sets,\icoprod}_{X}](0,x) &\eqdef \RUnitor^{\Sets,\icoprod,-1}_{X}(\RUnitor^{\Sets,\icoprod}_{X}(0,x))\\
                                                                                          &\eqdef \RUnitor^{\Sets,\icoprod,-1}_{X}(x)\\
                                                                                          &\eqdef (0,x)\\
                                                                                          &\eqdef [\id_{ X\icoprod\emptyset}](0,x)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\RUnitor^{\Sets,\icoprod}_{X}\circ\RUnitor^{\Sets,\icoprod,-1}_{X}](x) &\eqdef \RUnitor^{\Sets,\icoprod}_{X}(\RUnitor^{\Sets,\icoprod,-1}_{X}(x))\\
                                                                                        &\eqdef \RUnitor^{\Sets,\icoprod,-1}_{X}(0,x)\\
                                                                                        &\eqdef x\\
                                                                                        &\eqdef [\id_{X}](x)
            \end{align*}
            for each $x\in X$, and therefore we have
...
\begin{Proof}{Proof of the Claims Made in \cref{the-symmetry-of-the-coproduct-of-sets}}%
    ...
    \begin{itemize}
        \item\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
                [\sigma^{\Sets,\icoprod,-1}_{X,Y}\circ\sigma^{\Sets,\icoprod}_{X,Y}](0,x) &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(\sigma^{\Sets,\icoprod}_{X}(0,x))\\
                                                                                          &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(1,x)\\
                                                                                          &\eqdef (0,x)\\
                                                                                          &\eqdef [\id_{X\icoprod Y}](0,x)
            \end{align*}
            for each $(0,x)\in X\icoprod Y$ and
            \begin{align*}
                [\sigma^{\Sets,\icoprod,-1}_{X,Y}\circ\sigma^{\Sets,\icoprod}_{X,Y}](1,y) &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(\sigma^{\Sets,\icoprod}_{X}(1,y))\\
                                                                                          &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(0,y)\\
                                                                                          &\eqdef (1,y)\\
                                                                                          &\eqdef [\id_{X\icoprod Y}](1,y)
            \end{align*}
        ...
        \item\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
                [\sigma^{\Sets,\icoprod}_{X,Y}\circ\sigma^{\Sets,\icoprod,-1}_{X,Y}](0,y) &\eqdef \sigma^{\Sets,\icoprod}_{X}(\sigma^{\Sets,\icoprod,-1}_{X}(0,y))\\
                                                                                          &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(1,y)\\
                                                                                          &\eqdef (0,y)\\
                                                                                          &\eqdef \left[\id_{Y\icoprod X}\right](0,y)
            \end{align*}
            for each $(0,y)\in Y\icoprod X$ and
            \begin{align*}
                [\sigma^{\Sets,\icoprod}_{X,Y}\circ\sigma^{\Sets,\icoprod,-1}_{X,Y}](1,x) &\eqdef \sigma^{\Sets,\icoprod}_{X}(\sigma^{\Sets,\icoprod,-1}_{X}(1,x))\\
                                                                                          &\eqdef \sigma^{\Sets,\icoprod,-1}_{X}(0,x)\\
                                                                                          &\eqdef (1,x)\\
                                                                                          &\eqdef \left[\id_{Y\icoprod X}\right](1,x)
            \end{align*}
...
\begin{definition}{The Left Annihilator of $\times$}{the-left-annihilator-of-the-product-of-sets}%
    ...
    \[
        ...
        \emptyset%
    \]%
    defined by $\zeta^{\Sets}_{\ell|A}\defeq\pr_{1}$.
\end{definition}
...
\begin{definition}{The Right Annihilator of $\times$}{the-right-annihilator-of-the-product-of-sets}%
    ...
    \[
        ...
        \emptyset%
    \]%
    defined by $\zeta^{\Sets}_{r|A}\defeq\pr_{2}$.%
\end{definition}
