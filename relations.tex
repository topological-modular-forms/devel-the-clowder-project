...
\begin{proposition}{Properties of Coinverse Images \rmI}{properties-of-coinverse-image-functions-associated-to-relations-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-products}\SloganFont{Interaction With Products. }Let $f\colon X\rightproarrow X'$ and $g\colon Y\rightproarrow Y'$ be relations. The diagram
            ...
            \]%
            for each $U'\in\mathcal{P}(X')$ and each $V'\in\mathcal{P}(Y')$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-1}\SloganFont{Relation to Inverse Images \rmI. }We have
            \[
                R_{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-2}\SloganFont{Relation to Inverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}}%
    ...
    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-1}: Relation to Inverse Images \rmI}%
    ...
    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-2}: Relation to Inverse Images \rmII}%
...
\begin{proposition}{Properties of Inverse Images \rmI}{properties-of-inverse-image-functions-associated-to-relations-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-products}\SloganFont{Interaction With Products. }Let $R\colon X\rightproarrow X'$ and $S\colon Y\rightproarrow Y'$ be relations. The diagram
            ...
            \]%
            for each $U'\in\mathcal{P}(X')$ and each $V'\in\mathcal{P}(Y')$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-relation-to-coinverse-images-1}\SloganFont{Relation to Coinverse Images \rmI. }We have
            \[
                R^{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-relation-to-coinverse-images-2}\SloganFont{Relation to Coinverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-inverse-image-functions-associated-to-relations-1}}%
    ...
    \begin{itemize}
        \item \cref{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-binary-unions} for the second equality.
        \item \cref{properties-of-inverse-image-functions-associated-to-relations-1-relation-to-coinverse-images-1} for the third equality.
    \end{itemize}
    Since $\mathcal{P}(Y)$ is posetal, naturality is automatic (\ChapterRef{\ChapterCategories, \cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}{\cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}). This finishes the proof.
    ...
    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-1-relation-to-coinverse-images-1}: Relation to Coinverse Images \rmI}%
    This follows from \cref{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-1} of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-1-relation-to-coinverse-images-2}: Relation to Coinverse Images \rmII}%
    This was proved in \cref{properties-of-coinverse-image-functions-associated-to-relations-1-relation-to-inverse-images-2} of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}.
\end{Proof}
