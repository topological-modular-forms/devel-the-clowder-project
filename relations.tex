...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-1}}%
    ...
    \ProofBox{Step 1: \cref{characterisations-of-monomorphisms-in-rel-1-2}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-3} and \cref{characterisations-of-monomorphisms-in-rel-1-3}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-5}}%
    ...
    \ProofBox{Step 3: \cref{characterisations-of-monomorphisms-in-rel-1-2}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-4}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-4}: }We proceed in a few steps:
            \begin{itemize}
    ...
    \ProofBox{Step 4: \cref{characterisations-of-monomorphisms-in-rel-1-4}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-6}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-4}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-6}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U",  shift left=0.8,  mid vert]
        ...
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-6}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-4}: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S", shift left=0.8, mid vert]
    ...
    \ProofBox{Step 5: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-7}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-3}.

    \ProofBox{Step 6: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-9}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-3}.

    \ProofBox{Step 7: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-10}}%
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-3}}%
    \FirstProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-7}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-2-3} of \cref{characterisations-of-monomorphisms-in-rel-2}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-7}: }By assumption, given $a\in A$, there exists some $b\in B$ such that $R^{-1}(b)=\{a\}$. Invoking the axiom of choice, we may pick one such $b$ for each $a\in A$, giving us our desired function $f\colon A\to B$. All the requirements listed in \cref{characterisations-of-monomorphisms-in-rel-1-7} of \cref{characterisations-of-monomorphisms-in-rel-1} then follow by construction.
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-7}$\implies$\cref{characterisations-of-monomorphisms-in-rel-2-3} of \cref{characterisations-of-monomorphisms-in-rel-2}: }Given $a\in A$, we may pick $b=f(a)$, in which case $R^{-1}(f(a))$ will be equal to $\{a\}$ by assumption.
    \end{itemize}
    ...
    \ProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-9}}%
    Indeed, we have
    \begin{align*}
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-4}}%
    \ProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-10}}%
    ...
    \ProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-10}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-1}}%
