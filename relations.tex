...
\begin{explanation}{Monomorphisms in $\sfRel$}{explanation-monomorphisms-in-rel}%
    ...
    \begin{enumerate}
        ...
        \item\label{explanation-monomorphisms-in-rel-3}$R$ needs to be weakly injective, but it can fail to be injective.
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-1}}%
    ...
    \ProofBox{Step 1: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-2}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-4}.

    \ProofBox{Step 2: \cref{characterisations-of-monomorphisms-in-rel-1-3}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-4} and \cref{characterisations-of-monomorphisms-in-rel-1-4}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-6}}%
    ...
    \ProofBox{Step 3: First Proof of \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-3}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-3}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
        ...
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-3}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-1}: }Conversely, suppose that $R_{!}$ is injective, consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
    ...
    \ProofBox{Step 3.5: Second Proof of \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-3}}%
    ...
    \ProofBox{Step 4: \cref{characterisations-of-monomorphisms-in-rel-1-3}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-5}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-3}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-5}: }We proceed in a few steps:
            \begin{itemize}
    ...
    \ProofBox{Step 5: \cref{characterisations-of-monomorphisms-in-rel-1-5}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-7}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-5}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-7}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U",  shift left=0.8,  mid vert]
        ...
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-7}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-5}: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S", shift left=0.8, mid vert]
    ...
    \ProofBox{Step 6: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-8}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-3}.

    \ProofBox{Step 7: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-9}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-5}.

    \ProofBox{Step 8: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-10}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-3}.

    \ProofBox{Step 9: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-11}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-5}.

    \ProofBox{Step 10: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-12}}%
    We defer this proof to \cref{characterisations-of-monomorphisms-in-rel-5}.
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-3}}%
    \FirstProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-8}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-2-3} of \cref{characterisations-of-monomorphisms-in-rel-2}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-8}: }By assumption, given $a\in A$, there exists some $b\in B$ such that $R^{-1}(b)=\{a\}$. Invoking the axiom of choice, we may pick one such $b$ for each $a\in A$, giving us our desired function $f\colon A\to B$. All the requirements listed in \cref{characterisations-of-monomorphisms-in-rel-1-8} of \cref{characterisations-of-monomorphisms-in-rel-1} then follow by construction.
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-8}$\implies$\cref{characterisations-of-monomorphisms-in-rel-2-3} of \cref{characterisations-of-monomorphisms-in-rel-2}: }Given $a\in A$, we may pick $b=f(a)$, in which case $R^{-1}(f(a))$ will be equal to $\{a\}$ by assumption.
    \end{itemize}
    ...
    \ProofBox{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-10}}%
    Indeed, we have
    \begin{align*}
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-4}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-2}: }First, note that $R$ is total by \cref{characterisations-of-monomorphisms-in-rel-2-3} of \cref{characterisations-of-monomorphisms-in-rel-2}. Next, let $a,a'\in A$ such that $a\sim_{R}b$ and $a'\sim_{R}b$ for some $b\in B$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
            ...
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-1}: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S",  shift left=0.8,  mid vert]
...
\end{corollary}
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-5}}%
    We will prove this by showing:
    \begin{itemize}
    ...
    \FirstProofBox{Step 1: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-11}}%
    ...
    \ProofBox{Step 2: \cref{characterisations-of-monomorphisms-in-rel-1-11}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-1}}%
    ...
    \ProofBox{Step 3: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-12}}%
    ...
    \ProofBox{Step 4: \cref{characterisations-of-monomorphisms-in-rel-1-12}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-1}}%
    ...
    \ProofBox{Step 5: \cref{characterisations-of-monomorphisms-in-rel-1-9}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-13}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-13}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-9}: }Let $a\in A$.
            \begin{itemize}
            ...
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-9}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-13}: }We have
            \begin{align*}
    ...
    \ProofBox{Step 6: \cref{characterisations-of-monomorphisms-in-rel-1-9}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-2}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-9}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-2}: }By definition,
            \[
                R^{-1}(R(a))%
                =%
        ...
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-monomorphisms-in-rel-1-9}: }Let $a\in A$. We wish to show $R^{-1}(R(a))=\{a\}$.
        \begin{itemize}
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-1}}%
    ...
    \ProofBox{Step 1: \cref{characterisations-of-epimorphisms-in-rel-1-2}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-3} and \cref{characterisations-of-epimorphisms-in-rel-1-3}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-5}}%
    ...
    \ProofBox{Step 2: First Proof of \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-2}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-2}: }Let $U,V\in\mathcal{P}(B)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
        ...
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-1}: }Conversely, suppose that $R^{-1}$ is injective, consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
    ...
    \ProofBox{Step 2.5: Second Proof of \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-2}}%
    A more abstract proof can also be given, following \cite{MSE350788}:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-2}: }Assume that $R$ is an epimorphism.
            \begin{itemize}
            ...
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-1}: }Assume that $R^{-1}$ is injective.
            \begin{itemize}
                \item We first notice that the functor $\Rel(-,\pt)\colon\Rel^{\op}\to\Sets$ maps $R$ to $R^{-1}$ by \cref{unwinding-the-inverse-image-function-associated-to-a-relation}.
    ...
    \ProofBox{Step 3: \cref{characterisations-of-epimorphisms-in-rel-1-2}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-4}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-4}: }We proceed in a few steps:
            \begin{itemize}
    ...
    \ProofBox{Step 4: \cref{characterisations-of-epimorphisms-in-rel-1-4}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-6}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-4}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-6}: }Let $U,V\in\mathcal{P}(B)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
        ...
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-6}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-4}: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
    ...
    \ProofBox{Step 5: \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-7}}%
    We defer this proof to \cref{characterisations-of-epimorphisms-in-rel-3}.

    \ProofBox{Step 6: \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-8}}%
    We defer this proof to \cref{characterisations-of-epimorphisms-in-rel-3}.

    \ProofBox{Step 6: \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-9}}%
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-3}}%
    \FirstProofBox{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-7}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-7}: }By assumption, given $b\in B$, there exists some $a\in A$ such that $R(a)=\{b\}$. Invoking the axiom of choice, we may pick one such $a$ for each $b\in B$, giving us our desired function $f\colon B\to A$. All the requirements listed in \cref{characterisations-of-epimorphisms-in-rel-1-7} then follow by construction.
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-7}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2}: }Given $b\in B$, we may pick $a=f(b)$, in which case $R(f(b))$ will be equal to $\{b\}$ by assumption.
    \end{itemize}
    ...
    \ProofBox{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-8}}%
    Indeed, we have
    \begin{align*}
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-4}}%
    \FirstProofBox{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-9}}%
    ...
    \ProofBox{\cref{characterisations-of-epimorphisms-in-rel-1-9}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-1}}%
...
% modify the definition below so that the formula R_!(U) = B in B | R^{-1}(B)\cap U\neq\emptyset appears.
...
\end{Proof}
\subsection{Coinverse Images}\label{subsection-coinverse-images}
Let $X$ and $Y$ be sets and let $R\colon X\rightproarrow Y$ be a relation.
...
\begin{proposition}{Properties of Coinverse Images}{properties-of-coinverse-image-functions-associated-to-relations}%
    Let $R\colon X\rightproarrow Y$ be a relation.
    \begin{enumerate}
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-functoriality}\SloganFont{Functoriality. }The assignment $V\mapsto R_{-1}(V)$ defines a functor
            \[
                R_{-1}%
                \colon%
                (\mathcal{P}(Y),\subset)%
            ...
            \begin{itemize}
                ...
                \item\SloganFont{Action on Morphisms. }For each $U,V\in\mathcal{P}(Y)$:
                    ...
                    \end{itemize}
            \end{itemize}
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-adjointness}\SloganFont{Adjointness. }We have an adjunction
            \begin{webcompile}
                \Adjunction#R_{!}#R_{-1}#\mathcal{P}(X)#\mathcal{P}(Y),#
            \end{webcompile}
            ...
            \begin{itemize}
                \itemstar The following conditions are equivalent:
                    ...
                    \end{itemize}
            \end{itemize}
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-lax-preservation-of-colimits}\SloganFont{Lax Preservation of Colimits. }We have an inclusion of sets
            \[
        ...
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-preservation-of-limits}\SloganFont{Preservation of Limits. }We have an equality of sets
            \[
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-symmetric-lax-monoidality-with-respect-to-unions}\SloganFont{Symmetric Lax Monoidality With Respect to Unions. }The codirect image function of \cref{properties-of-coinverse-image-functions-associated-to-relations-functoriality} has a symmetric lax monoidal structure
            \[
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-symmetric-strict-monoidality-with-respect-to-intersections}\SloganFont{Symmetric Strict Monoidality With Respect to Intersections. }The direct image function of \cref{properties-of-coinverse-image-functions-associated-to-relations-functoriality} has a symmetric strict monoidal structure
            \[
                (R_{-1},R^{\otimes}_{-1},R^{\otimes}_{-1|\Unit})
                \colon
                (\mathcal{P}(X),\cap,X)
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-1}\SloganFont{Interaction With Inverse Images \rmI. }We have
            \[
                R_{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-2}\SloganFont{Interaction With Inverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
            ...
            \end{enumerate}
        %\item\label{properties-of-coinverse-image-functions-associated-to-relations-}\SloganFont{. }
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-coinverse-image-functions-associated-to-relations}}%
    \FirstProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-functoriality}: Functoriality}%
    Clear.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-adjointness}: Adjointness}%
    This follows from \ChapterRef{\ChapterKanExtensions, \cref{kan-extensions:properties-of-kan-extensions-triple-adjointness} of \cref{kan-extensions:properties-of-kan-extensions}}{\cref{properties-of-kan-extensions-triple-adjointness} of \cref{properties-of-kan-extensions}}.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-lax-preservation-of-colimits}: Lax Preservation of Colimits}%
    Omitted.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-preservation-of-limits}: Preservation of Limits}%
    This follows from \cref{properties-of-coinverse-image-functions-associated-to-relations-adjointness} and \ChapterRef{\ChapterAdjunctionsAndTheYonedaLemma, \cref{adjunctions-and-the-yoneda-lemma:properties-of-adjunctions-interaction-of-co-limits} of \cref{adjunctions-and-the-yoneda-lemma:properties-of-adjunctions}}{\cref{properties-of-adjunctions-interaction-of-co-limits} of \cref{properties-of-adjunctions}}.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-symmetric-lax-monoidality-with-respect-to-unions}: Symmetric Lax Monoidality With Respect to Unions}%
    This follows from \cref{properties-of-coinverse-image-functions-associated-to-relations-lax-preservation-of-colimits}.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-symmetric-strict-monoidality-with-respect-to-intersections}: Symmetric Strict Monoidality With Respect to Intersections}%
    This follows from \cref{properties-of-coinverse-image-functions-associated-to-relations-preservation-of-limits}.

    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-1}: Interaction With Inverse Images \rmI}%
    ...
    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-2}: Interaction With Inverse Images \rmII}%
...
\begin{proposition}{Properties of the Coinverse Image Function Operation}{properties-of-the-coinverse-image-function-operation-for-relations}%
    Let $R\colon X\rightproarrow Y$ be a relation.
    \begin{enumerate}
        \item\label{properties-of-the-coinverse-image-function-operation-for-relations-functionality-1}\SloganFont{Functionality \rmI. }The assignment $R\mapsto R_{-1}$ defines a function
            \[
                (-)_{-1}%
                \colon%
                \Sets(X,Y)
                ...
                \Sets(\mathcal{P}(X),\mathcal{P}(Y)).
            \]%
        \item\label{properties-of-the-coinverse-image-function-operation-for-relations-functionality-2}\SloganFont{Functionality \rmII. }The assignment $R\mapsto R_{-1}$ defines a function
            \[
                (-)_{-1}%
                \colon%
                \Sets(X,Y)
                ...
                \Pos((\mathcal{P}(X),\subset),(\mathcal{P}(Y),\subset)).
            \]%
        \item\label{properties-of-the-coinverse-image-function-operation-for-relations-interaction-with-identities}\SloganFont{Interaction With Identities. }For each $X\in\Obj(\Sets)$, we have
            \[
                (\id_{X})_{-1}%
                =%
                \id_{\mathcal{P}(X)}.%
            \]%
        \item\label{properties-of-the-coinverse-image-function-operation-for-relations-interaction-with-composition}\SloganFont{Interaction With Composition. }For each pair of composable relations $R\colon X\rightproarrow Y$ and $S\colon Y\rightproarrow C$, we have%
            \begin{webcompile}
                (S\procirc R)_{-1}%
                =%
                R_{-1}\circ S_{-1},%
                ...
                \end{tikzcd}
            \end{webcompile}
        %\item\label{properties-of-the-coinverse-image-function-operation-for-relations-}\SloganFont{. }
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-the-coinverse-image-function-operation-for-relations}}%
    \FirstProofBox{\cref{properties-of-the-coinverse-image-function-operation-for-relations-functionality-1}: Functionality \rmI}%
    Clear.

    \ProofBox{\cref{properties-of-the-coinverse-image-function-operation-for-relations-functionality-2}: Functionality \rmII}%
    Clear.

    \ProofBox{\cref{properties-of-the-coinverse-image-function-operation-for-relations-interaction-with-identities}: Interaction With Identities}%
    Indeed, we have
    \begin{align*}
    ...
    \ProofBox{\cref{properties-of-the-coinverse-image-function-operation-for-relations-interaction-with-composition}: Interaction With Composition}%
    Indeed, we have
    \begin{align*}
...
\begin{definition}{Inverse Images}{the-inverse-image-function-associated-to-a-relation}%
    The \index[set-theory]{relation!associated inverse image function}\textbf{inverse image function associated to $R$}%
    %--- Begin Footnote ---%
    \footnote{%
...
\begin{remark}{Unwinding \cref{the-inverse-image-function-associated-to-a-relation}}{unwinding-the-inverse-image-function-associated-to-a-relation}%
    Identifying subsets of $Y$ with relations from $Y$ to $\pt$ via \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:elementary-properties-of-powersets-powersets-as-sets-of-relations} of \cref{constructions-with-sets:elementary-properties-of-powersets}}{\cref{elementary-properties-of-powersets-powersets-as-sets-of-relations} of \cref{elementary-properties-of-powersets}}, we see that the inverse image function associated to $R$ is equivalently the function
    \[
        R^{-1}%
        \colon%
...
\begin{Proof}{Proof of \cref{unwinding-the-inverse-image-function-associated-to-a-relation}}%
    ...
    This finishes the proof.
\end{Proof}
\begin{proposition}{Properties of Inverse Image Functions}{properties-of-inverse-image-functions-associated-to-relations}%
    Let $R\colon X\rightproarrow Y$ be a relation.
    \begin{enumerate}
        \item\label{properties-of-inverse-image-functions-associated-to-relations-functoriality}\SloganFont{Functoriality. }The assignment $V\mapsto R^{-1}(V)$ defines a functor
            \[
                R^{-1}%
                \colon%
                (\mathcal{P}(Y),\subset)%
            ...
            \begin{itemize}
                ...
                \item\SloganFont{Action on Morphisms. }For each $U,V\in\mathcal{P}(Y)$:
                    ...
                    \end{itemize}
            \end{itemize}
        \item\label{properties-of-inverse-image-functions-associated-to-relations-adjointness}\SloganFont{Adjointness. }We have an adjunction
            \begin{webcompile}
            ...
            \begin{itemize}
                \itemstar The following conditions are equivalent:
                    ...
                    \end{itemize}
            \end{itemize}
        \item\label{properties-of-inverse-image-functions-associated-to-relations-preservation-of-colimits}\SloganFont{Preservation of Colimits. }We have an equality of sets
            \[
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-oplax-preservation-of-limits}\SloganFont{Oplax Preservation of Limits. }We have an inclusion of sets
            \[
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-symmetric-strict-monoidality-with-respect-to-unions}\SloganFont{Symmetric Strict Monoidality With Respect to Unions. }The direct image function of \cref{properties-of-inverse-image-functions-associated-to-relations-functoriality} has a symmetric strict monoidal structure
            \[
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-symmetric-oplax-monoidality-with-respect-to-intersections}\SloganFont{Symmetric Oplax Monoidality With Respect to Intersections. }The direct image function of \cref{properties-of-inverse-image-functions-associated-to-relations-functoriality} has a symmetric oplax monoidal structure
            \[
                (R^{-1},R^{-1,\otimes},R^{-1,\otimes}_{\Unit})
                \colon
                (\mathcal{P}(X),\cap,X)
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-1}\SloganFont{Interaction With Coinverse Images \rmI. }We have
            \[
                R^{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-2}\SloganFont{Interaction With Coinverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
                \item\label{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-2-a}If $R$ is a total relation, then we have an inclusion of sets
                    ...
                    \]%
                    natural in $V\in\mathcal{P}(Y)$.
                \item\label{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-2-b}If $R$ is total and functional, then the above inclusion is in fact an equality.
                \item\label{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-2-c}Conversely, if we have $R_{-1}=R^{-1}$, then $R$ is total and functional.
            \end{enumerate}
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-inverse-image-functions-associated-to-relations}}%
    \FirstProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-functoriality}: Functoriality}%
    Clear.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-adjointness}: Adjointness}%
    This follows from \ChapterRef{\ChapterKanExtensions, \cref{kan-extensions:properties-of-kan-extensions-triple-adjointness} of \cref{kan-extensions:properties-of-kan-extensions}}{\cref{properties-of-kan-extensions-triple-adjointness} of \cref{properties-of-kan-extensions}}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-preservation-of-colimits}: Preservation of Colimits}%
    This follows from \cref{properties-of-inverse-image-functions-associated-to-relations-adjointness} and \ChapterRef{\ChapterAdjunctionsAndTheYonedaLemma, \cref{adjunctions-and-the-yoneda-lemma:properties-of-adjunctions-interaction-of-co-limits} of \cref{adjunctions-and-the-yoneda-lemma:properties-of-adjunctions}}{\cref{properties-of-adjunctions-interaction-of-co-limits} of \cref{properties-of-adjunctions}}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-oplax-preservation-of-limits}: Oplax Preservation of Limits}%
    Omitted.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-symmetric-strict-monoidality-with-respect-to-unions}: Symmetric Strict Monoidality With Respect to Unions}%
    This follows from \cref{properties-of-inverse-image-functions-associated-to-relations-preservation-of-colimits}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-symmetric-oplax-monoidality-with-respect-to-intersections}: Symmetric Oplax Monoidality With Respect to Intersections}%
    This follows from \cref{properties-of-inverse-image-functions-associated-to-relations-oplax-preservation-of-limits}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-1}: Interaction With Coinverse Images \rmI}%
    ...
    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-2}: Interaction With Coinverse Images \rmII}%
...
\end{Proof}
\begin{proposition}{Properties of the Inverse Image Function Operation}{properties-of-the-inverse-image-function-operation-for-relations}%
    Let $R\colon X\rightproarrow Y$ be a relation.
    \begin{enumerate}
        \item\label{properties-of-the-inverse-image-function-operation-for-relations-functionality-1}\SloganFont{Functionality \rmI. }The assignment $R\mapsto R^{-1}$ defines a function
            \[
                (-)^{-1}%
                \colon%
                \Rel(X,Y)
                ...
                \Sets(\mathcal{P}(X),\mathcal{P}(Y)).
            \]%
        \item\label{properties-of-the-inverse-image-function-operation-for-relations-functionality-2}\SloganFont{Functionality \rmII. }The assignment $R\mapsto R^{-1}$ defines a function
            \[
                (-)^{-1}%
                \colon%
                \Rel(X,Y)
                ...
                \Pos((\mathcal{P}(X),\subset),(\mathcal{P}(Y),\subset)).
            \]%
        \item\label{properties-of-the-inverse-image-function-operation-for-relations-interaction-with-identities}\SloganFont{Interaction With Identities. }For each $X\in\Obj(\Sets)$, we have%
            %--- Begin Footnote ---%
            \footnote{%
            ...
            \[
                ...
                \id_{\mathcal{P}(X)}.%
            \]%
        \item\label{properties-of-the-inverse-image-function-operation-for-relations-interaction-with-composition}\SloganFont{Interaction With Composition. }For each pair of composable relations $R\colon X\rightproarrow Y$ and $S\colon Y\rightproarrow C$, we have%
            %--- Begin Footnote ---%
            \footnote{%
                That is, we have
                \begin{webcompile}
            ...
            \begin{webcompile}
                ...
                \end{tikzcd}
            \end{webcompile}
        %\item\label{properties-of-the-inverse-image-function-operation-for-relations-}\SloganFont{. }
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-the-inverse-image-function-operation-for-relations}}%
    \FirstProofBox{\cref{properties-of-the-inverse-image-function-operation-for-relations-functionality-1}: Functionality \rmI}%
    Clear.

    \ProofBox{\cref{properties-of-the-inverse-image-function-operation-for-relations-functionality-2}: Functionality \rmII}%
    Clear.

    \ProofBox{\cref{properties-of-the-inverse-image-function-operation-for-relations-interaction-with-identities}: Interaction With Identities}%
    ...
    \ProofBox{\cref{properties-of-the-inverse-image-function-operation-for-relations-interaction-with-composition}: Interaction With Composition}%
