...
\begin{enumerate}
    ...
    \item\label{relations-introduction-item-5}The adjoint pairs% TODO: FIX LABEL NUMBERING
        ...
        \begin{enumerate}
            ...
            \item\label{relations-introduction-item-5b}We have $R_{-1}=R^{-1}$ \textiff $R$ is total and functional (\cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2} of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}).
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-1}}%
    ...
    This follows from \cref{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-1} of \cref{properties-of-inverse-image-functions-associated-to-relations-1}.
...
\begin{Proof}{Proof of \cref{internal-left-kan-extensions-in-rel}}%
    ...
    \begin{itemize}
        ...
        \item Finally $R^{-1}$ has a left adjoint precisely when $R=\Gr(f)$ for $f$ a function (\cref{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2} of \cref{properties-of-inverse-image-functions-associated-to-relations-1}).
    \end{itemize}
    This finishes the proof.
\end{Proof}
...
\begin{Proof}{Proof of \cref{properties-of-direct-image-functions-associated-to-relations-1}}%
    ...
    \begin{itemize}
        ...
        \item \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-symmetric-differences-via-unions-and-intersections} of \cref{constructions-with-sets:properties-of-symmetric-differences}}{\cref{properties-of-symmetric-differences-via-unions-and-intersections} of \cref{properties-of-symmetric-differences}} for the third equality.
    \end{itemize}
    Since $\mathcal{P}(Y)$ is posetal, naturality is automatic (\ChapterRef{\ChapterCategories, \cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}{\cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}). This finishes the proof.
...
\begin{remark}{Unwinding \cref{the-coinverse-image-function-associated-to-a-relation}}{unwinding-the-coinverse-image-function-associated-to-a-relation}%
    ...
    \begin{webcompile}
        ...
        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
            ...
            \\
            \pt%
            \arrow[ru,"\Rift_{R}(V)",dashed for mid vert, mid vert]
...
\begin{proposition}{Properties of Coinverse Images \rmI}{properties-of-coinverse-image-functions-associated-to-relations-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-products}\SloganFont{Interaction With Products. }Let $f\colon X\rightproarrow X'$ and $g\colon Y\rightproarrow Y'$ be relations. The diagram
            ...
            \]%
            for each $U'\in\mathcal{P}(X')$ and each $V'\in\mathcal{P}(Y')$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-1}\SloganFont{Interaction With Inverse Images \rmI. }We have
            \[
                R_{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2}\SloganFont{Interaction With Inverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
                \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-a}If $R$ is a total relation, then we have an inclusion of sets
                    \[
                        R_{-1}(V)
                        \subset
                        R^{-1}(V)
                ...
                \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-b}If $R$ is total and functional, then the above inclusion is in fact an equality.
                \item\label{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-c}Conversely, if we have $R_{-1}=R^{-1}$, then $R$ is total and functional.
            \end{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}}%
    ...
    Applying \cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-1} to $X\setminus U$, we have
    \begin{align*}
    ...
    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-1}: Interaction With Inverse Images \rmI}%
    ...
    \ProofBox{\cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2}: Interaction With Inverse Images \rmII}%
    \cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-a} is clear, while \cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-b,properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2-c} follow from \cref{properties-of-graphs-of-functions-characterisations} of \cref{properties-of-graphs-of-functions}.
\end{Proof}
...
\begin{proposition}{Properties of Inverse Images \rmI}{properties-of-inverse-image-functions-associated-to-relations-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-symmetric-oplax-monoidality-with-respect-to-intersections}\SloganFont{Symmetric Oplax Monoidality With Respect to Intersections. }The direct image function of \cref{properties-of-inverse-image-functions-associated-to-relations-1-functoriality} has a symmetric oplax monoidal structure
            ...
            \]%
            natural in $U,V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-1}\SloganFont{Interaction With Coinverse Images \rmI. }We have
            \[
                R^{-1}(V)%
                =%
            ...
            \]%
            for each $V\in\mathcal{P}(Y)$.
        \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2}\SloganFont{Interaction With Coinverse Images \rmII. }Let $R\colon X\rightproarrow Y$ be a relation from $X$ to $Y$.
            \begin{enumerate}
                \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2-a}If $R$ is a total relation, then we have an inclusion of sets
                    \[
                        R_{-1}(V)
                        \subset
                        R^{-1}(V)
                    \]%
                    natural in $V\in\mathcal{P}(Y)$.
                \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2-b}If $R$ is total and functional, then the above inclusion is in fact an equality.
                \item\label{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2-c}Conversely, if we have $R_{-1}=R^{-1}$, then $R$ is total and functional.
            \end{enumerate}
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-inverse-image-functions-associated-to-relations-1}}%
    ...
    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-1}: Interaction With Coinverse Images \rmI}%
    This follows from \cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-1} of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}.

    \ProofBox{\cref{properties-of-inverse-image-functions-associated-to-relations-1-interaction-with-coinverse-images-2}: Interaction With Coinverse Images \rmII}%
    This was proved in \cref{properties-of-coinverse-image-functions-associated-to-relations-1-interaction-with-inverse-images-2} of \cref{properties-of-coinverse-image-functions-associated-to-relations-1}.
\end{Proof}
...
\begin{Proof}{Proof of \cref{functoriality-of-powersets-1}}%
    This follows from \cref{properties-of-direct-image-functions-associated-to-relations-2-interaction-with-identities,properties-of-direct-image-functions-associated-to-relations-2-interaction-with-composition} of \cref{properties-of-direct-image-functions-associated-to-relations-2}, \cref{properties-of-coinverse-image-functions-associated-to-relations-2-interaction-with-identities,properties-of-coinverse-image-functions-associated-to-relations-2-interaction-with-composition} of \cref{properties-of-coinverse-image-functions-associated-to-relations-2}, \cref{properties-of-inverse-image-functions-associated-to-relations-2-interaction-with-identities,properties-of-inverse-image-functions-associated-to-relations-2-interaction-with-composition} of \cref{properties-of-inverse-image-functions-associated-to-relations-2}, and \cref{properties-of-the-codirect-image-function-operation-for-relations-interaction-with-identities,properties-of-the-codirect-image-function-operation-for-relations-interaction-with-composition} of \cref{properties-of-the-codirect-image-function-operation-for-relations}.
\end{Proof}
