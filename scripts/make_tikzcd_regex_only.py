...
def main(input_file):
    ...
    # Process webprooftree environments
    webprooftree_pattern = re.compile(r'\\begin\{webprooftree\}(.*?)\\end\{webprooftree\}', re.DOTALL)
    webprooftree_environments = webprooftree_pattern.findall(content)
