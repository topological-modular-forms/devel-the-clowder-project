...
\begin{itemize}
    \item Fix categories having an underlying set of objects by having them have an underlying setoid of objects (not necessarily by definition, as that'll likely be bothersome; at least \cref{section-the-quadruple-adjunction-with-sets} should be fixed and several remarks should be added at several points). Related: \cref{the-quadruple-adjunction-between-sets-and-cats-cannot-be-enhanced-to-a-two-categorical-adjunction}
        \begin{enumerate}
            \item \url{https://math.stackexchange.com/questions/1053082/why-thin-groupoids-are-not-ubiquitous}
            \item \url{https://stacks.math.columbia.edu/tag/04S9}
            \item \url{https://ncatlab.org/nlab/show/setoid}
            \item \url{https://ncatlab.org/nlab/show/Bishop+set}
        \end{enumerate}
\end{itemize}
...
\end{notation}
\begin{proposition}{Properties of Isomorphisms}{properties-of-isomorphisms}%
    Let $\CatFont{C}$ be a category.
    \begin{enumerate}
        \item\label{properties-of-isomorphisms-two-out-of-three}\SloganFont{Two-Out-of-Three. }Let
            \[
                ...
                \end{tikzcd}
            \]%
            be a diagram in $\CatFont{C}$. If two out of the three morphisms among $f$, $g$, and $g\circ f$ are isomorphisms, then so is the third.
        %\item\label{properties-of-isomorphisms-}\SloganFont{. }
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{properties-of-isomorphisms}}%
    \FirstProofBox{\cref{properties-of-isomorphisms-two-out-of-three}: Two-Out-of-Three}%
    Omitted.
\end{Proof}
...
\begin{proposition}{Properties of Equivalences of Categories}{properties-of-equivalences-of-categories}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-equivalences-of-categories-equivalences-of-groupoids}\SloganFont{Equivalences of Groupoids. }Let $F\colon\CatFont{G}\to\CatFont{H}$ be a functor between groupoids. The following conditions are equivalent:
            \begin{enumerate}
                \item\label{properties-of-equivalences-of-categories-equivalences-of-groupoids-a}The functor $F\colon\CatFont{G}\to\CatFont{H}$ is an equivalence of groupoids.
                \item\label{properties-of-equivalences-of-categories-equivalences-of-groupoids-b}The following conditions are satisfied:
                    \begin{enumerate}
                        \item\label{properties-of-equivalences-of-categories-equivalences-of-groupoids-b-i}The functor $F$ induces a bijection
                            \[
                                \pi_{0}(F)%
                                \colon%
                                \pi_{0}(\CatFont{G})%
                            ...
                            \]%
                            of sets.
                        \item\label{properties-of-equivalences-of-categories-equivalences-of-groupoids-b-ii}For each $x\in\Obj(\CatFont{G})$, the action on morphisms
                            \[
                                F_{x,x}%
                                \colon%
                                \Aut_{\CatFont{G}}(x)%
...
\begin{Proof}{Proof of \cref{properties-of-equivalences-of-categories}}%
    ...
    \end{align*}
    Since $\eta^{\circ}$ and $\epsilon^{\circ}$ are compositions of whiskerings of natural isomorphisms, they are natural transformations by \cref{whiskering-of-functors-with-natural-transformations} and natural isomorphisms by \cref{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms-b,properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms-c} of \cref{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms} of \cref{properties-of-horizontal-composition-of-natural-transformations}.
...
\begin{proposition}{Properties of Vertical Composition of Natural Transformations}{properties-of-vertical-composition-of-natural-transformations}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-vertical-composition-of-natural-transformations-middle-four-exchange}\SloganFont{Middle Four Exchange. }\index[categories]{middle four exchange!in Cats@in $\Cats$}Let $F_{1},F_{2},F_{3}\colon\CatFont{C}\to\CatFont{D}$ and $G_{1},G_{2},G_{3}\colon\CatFont{D}\to\CatFont{E}$ be functors. The diagram
            ...
            \]%
        \item\label{properties-of-vertical-composition-of-natural-transformations-interaction-with-natural-isomorphisms}\SloganFont{Interaction With Natural Isomorphisms. }If $\alpha$ and $\beta$ are natural isomorphisms, then so is $\beta\circ\alpha$.
...
\begin{Proof}{Proof of \cref{properties-of-vertical-composition-of-natural-transformations}}%
    ...
    \ProofBox{\cref{properties-of-vertical-composition-of-natural-transformations-interaction-with-natural-isomorphisms}: Interaction With Natural Isomorphisms}%
    Omitted.
\end{Proof}
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-horizontal-composition-of-natural-transformations-middle-four-exchange}\SloganFont{Middle Four Exchange. }\index[categories]{middle four exchange!in Cats@in $\Cats$}Let $F_{1},F_{2},F_{3}\colon\CatFont{C}\to\CatFont{D}$ and $G_{1},G_{2},G_{3}\colon\CatFont{D}\to\CatFont{E}$ be functors. The diagram
            ...
            \[
                ...
                (\beta'\circ\beta)\twocirc(\alpha'\circ\alpha).%
            \]%
        \item\label{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms}\SloganFont{Interaction With Natural Isomorphisms. }Let $\alpha\colon F_{1}\Rightarrow G_{1}$ and $\beta\colon F_{2}\Rightarrow G_{2}$ be natural transformations.
            \begin{enumerate}
                \item\label{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms-a}If $\alpha$ and $\beta$ are natural isomorphisms, then so is $\beta\twocirc\alpha$.
                \item\label{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms-b}If $\alpha$ is an isomorphism, then so is $\id_{G_{1}}\twocirc\alpha\colon G_{1}\circ F_{1}\Rightarrow G_{1}\circ F_{2}$.
                \item\label{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms-c}If $\beta$ is an isomorphism, then so is $\beta\twocirc\id_{F_{1}}\colon G_{1}\circ F_{1}\Rightarrow G_{2}\circ F_{1}$.
            \end{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-horizontal-composition-of-natural-transformations}}%
    ...
    \ProofBox{\cref{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms}: Interaction With Natural Isomorphisms}%
    Omitted.
\end{Proof}
...
\begin{proposition}{Properties of Natural Isomorphisms}{properties-of-natural-isomorphisms}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-natural-isomorphisms-interaction-with-vertical-composition}\SloganFont{Interaction With Vertical Composition. }If $\alpha$ and $\beta$ are natural isomorphisms, then so is $\beta\circ\alpha$.
        \item\label{properties-of-natural-isomorphisms-interaction-with-horizontal-composition}\SloganFont{Interaction With Horizontal Composition. }Let $\alpha\colon F_{1}\Rightarrow G_{1}$ and $\beta\colon F_{2}\Rightarrow G_{2}$ be natural transformations.
            \begin{enumerate}
                \item\label{properties-of-natural-isomorphisms-interaction-with-horizontal-composition-a}If $\alpha$ and $\beta$ are natural isomorphisms, then so is $\beta\twocirc\alpha$.
                \item\label{properties-of-natural-isomorphisms-interaction-with-horizontal-composition-b}If $\alpha$ is an isomorphism, then so is $\id_{G_{1}}\twocirc\alpha\colon G_{1}\circ F_{1}\Rightarrow G_{1}\circ F_{2}$.
                \item\label{properties-of-natural-isomorphisms-interaction-with-horizontal-composition-c}If $\beta$ is an isomorphism, then so is $\beta\twocirc\id_{F_{1}}\colon G_{1}\circ F_{1}\Rightarrow G_{2}\circ F_{1}$.
            \end{enumerate}
...
\begin{Proof}{Proof of \cref{properties-of-natural-isomorphisms}}%
    ...
    \ProofBox{\cref{properties-of-natural-isomorphisms-interaction-with-vertical-composition}: Interaction With Vertical Composition}%
    This is a repetition of \cref{properties-of-vertical-composition-of-natural-transformations-interaction-with-natural-isomorphisms} of \cref{properties-of-vertical-composition-of-natural-transformations} and is proved there.

    \ProofBox{\cref{properties-of-natural-isomorphisms-interaction-with-horizontal-composition}: Interaction With Horizontal Composition}%
    This is a repetition of \cref{properties-of-horizontal-composition-of-natural-transformations-interaction-with-natural-isomorphisms} of \cref{properties-of-horizontal-composition-of-natural-transformations} and is proved there.
\end{Proof}
