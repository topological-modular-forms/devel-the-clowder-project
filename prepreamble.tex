...
%\newcommand{\Minitoc}{\begingroup{\hypersetup{hidelinks}\minitoc}\endgroup}
\newcommand{\Minitoc}{}% Only until we figure how to make these work with LaTeX past 2025/08
%%%% MATH DEFINITIONS %%%%
