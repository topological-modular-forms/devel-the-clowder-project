...
\usepackage{etoolbox}
\makeatletter
% Define a helper command to avoid repetition
\newcommand\setcustomdisplaydefaults{%
  \displaywidth=\textwidth
  \displayindent=-\leftskip
}
% Add this code to the beginning of each specified environment
\AddToHook{env/gather/before}{\setcustomdisplaydefaults}
\AddToHook{env/align/before}{\setcustomdisplaydefaults}
\AddToHook{env/multline/before}{\setcustomdisplaydefaults}
% For \[...\] and the `displaymath` environment
\AddToHook{env/displaymath/before}{\setcustomdisplaydefaults}
% Simpler alternative:
%\everydisplay{%
%  \displaywidth=\textwidth
%  \displayindent=-\leftskip
...
\newcommand{\lt}{<}
\newcommand{\gt}{>}
\newcommand{\scriptdisplaystyle}[1]{\scalebox{0.75}{$\displaystyle #1$}}
